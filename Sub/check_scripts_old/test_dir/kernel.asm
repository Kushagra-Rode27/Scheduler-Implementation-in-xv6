...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 0b 84 10 80 	movl   $0x8010840b,(%esp)
...
8010041a:	e8 71 61 00 00       	call   80106590 <uartputc>
...
80100a0e:	e9 bd 39 00 00       	jmp    801043d0 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
...
80100a44:	e8 a7 38 00 00       	call   801042f0 <wakeup>
...
80100b32:	75 d2                	jne    80100b06 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100b34:	e8 e7 6b 00 00       	call   80107720 <setupkvm>
...
80100ba3:	e8 98 69 00 00       	call   80107540 <allocuvm>
...
80100bd9:	e8 72 68 00 00       	call   80107450 <loaduvm>
...
80100c1b:	e8 80 6a 00 00       	call   801076a0 <freevm>
  if(ip){
...
80100c62:	e8 d9 68 00 00       	call   80107540 <allocuvm>
...
80100c81:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c83:	e8 38 6b 00 00       	call   801077c0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cf8:	e8 93 6c 00 00       	call   80107990 <copyout>
...
80100d11:	e8 8a 69 00 00       	call   801076a0 <freevm>
...
80100d5d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d63:	e8 28 6c 00 00       	call   80107990 <copyout>
...
80100dcd:	e8 ee 64 00 00       	call   801072c0 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 c6 68 00 00       	call   801076a0 <freevm>
  return 0;
...
80102088:	68 ce 81 10 80       	push   $0x801081ce
...
801022ad:	e8 3e 20 00 00       	call   801042f0 <wakeup>
...
80102369:	e8 c2 1e 00 00       	call   80104230 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102d85:	e8 a6 14 00 00       	call   80104230 <sleep>
...
80102e49:	00 00 00 
    wakeup(&log);
80102e4c:	e8 9f 14 00 00       	call   801042f0 <wakeup>
    release(&log.lock);
...
80102f08:	e8 e3 13 00 00       	call   801042f0 <wakeup>
  release(&log.lock);
...
80103022:	e8 49 31 00 00       	call   80106170 <idtinit>
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 65 42 00 00       	call   801072b0 <switchkvm>
  seginit();
8010304b:	e8 d0 41 00 00       	call   80107220 <seginit>
  lapicinit();
...
80103081:	e8 1a 47 00 00       	call   801077a0 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 8b 41 00 00       	call   80107220 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 07 34 00 00       	call   801064b0 <uartinit>
  pinit();         // process table
801030a9:	e8 02 09 00 00       	call   801039b0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 3d 30 00 00       	call   801060f0 <tvinit>
  binit();         // buffer cache
...
80103119:	e8 b2 08 00 00       	call   801039d0 <mycpu>
...
80103182:	e8 f9 08 00 00       	call   80103a80 <userinit>
...
8010355f:	e8 8c 0d 00 00       	call   801042f0 <wakeup>
...
801035c4:	e8 27 0d 00 00       	call   801042f0 <wakeup>
...
80103621:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->readopen == 0 || myproc()->killed){
80103628:	e8 23 04 00 00       	call   80103a50 <myproc>
...
80103638:	e8 b3 0c 00 00       	call   801042f0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010363d:	58                   	pop    %eax
8010363e:	5a                   	pop    %edx
8010363f:	53                   	push   %ebx
80103640:	56                   	push   %esi
80103641:	e8 ea 0b 00 00       	call   80104230 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
801036ba:	e8 31 0c 00 00       	call   801042f0 <wakeup>
  release(&p->lock);
...
801036fe:	66 90                	xchg   %ax,%ax
    if(myproc()->killed){
80103700:	e8 4b 03 00 00       	call   80103a50 <myproc>
...
80103715:	e8 16 0b 00 00       	call   80104230 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103776:	e8 75 0b 00 00       	call   801042f0 <wakeup>
  release(&p->lock);
...
801037ff:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
80103805:	e8 86 15 00 00       	call   80104d90 <release>
...
80103827:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382a:	c7 40 14 dd 60 10 80 	movl   $0x801060dd,0x14(%eax)
  p->context = (struct context*)sp;
...
80103839:	e8 72 16 00 00       	call   80104eb0 <memset>
...
80103862:	e8 29 15 00 00       	call   80104d90 <release>
}
...
8010389b:	e8 f0 14 00 00       	call   80104d90 <release>
...
801038ec:	89 d6                	mov    %edx,%esi
int power(int a, int b) {
801038ee:	53                   	push   %ebx
  int temp = power(a, b / 2);
801038ef:	c1 ee 1f             	shr    $0x1f,%esi
int power(int a, int b) {
801038f2:	89 d3                	mov    %edx,%ebx
  int temp = power(a, b / 2);
801038f4:	01 d6                	add    %edx,%esi
int power(int a, int b) {
801038f6:	83 ec 1c             	sub    $0x1c,%esp
  if (b == 0) {
801038f9:	d1 fe                	sar    %esi
801038fb:	75 23                	jne    80103920 <power.part.0+0x40>
  if (b % 2 == 0) {
801038fd:	83 e3 01             	and    $0x1,%ebx
80103900:	75 0e                	jne    80103910 <power.part.0+0x30>
    return temp * temp;
  } else {
    return a * temp * temp;
  }
}
80103902:	83 c4 1c             	add    $0x1c,%esp
    return temp * temp;
80103905:	0f af c0             	imul   %eax,%eax
}
80103908:	5b                   	pop    %ebx
80103909:	5e                   	pop    %esi
8010390a:	5f                   	pop    %edi
...
8010390d:	8d 76 00             	lea    0x0(%esi),%esi
    return a * temp * temp;
80103910:	0f af f8             	imul   %eax,%edi
}
80103913:	83 c4 1c             	add    $0x1c,%esp
80103916:	5b                   	pop    %ebx
80103917:	5e                   	pop    %esi
    return a * temp * temp;
80103918:	0f af c7             	imul   %edi,%eax
}
8010391b:	5f                   	pop    %edi
8010391c:	5d                   	pop    %ebp
8010391d:	c3                   	ret    
8010391e:	66 90                	xchg   %ax,%ax
  int temp = power(a, b / 2);
80103920:	85 d2                	test   %edx,%edx
80103922:	8d 4a 03             	lea    0x3(%edx),%ecx
80103925:	0f 49 ca             	cmovns %edx,%ecx
  if (b == 0) {
80103928:	c1 f9 02             	sar    $0x2,%ecx
8010392b:	74 18                	je     80103945 <power.part.0+0x65>
  int temp = power(a, b / 2);
8010392d:	85 db                	test   %ebx,%ebx
8010392f:	8d 52 07             	lea    0x7(%edx),%edx
80103932:	0f 49 d3             	cmovns %ebx,%edx
  if (b == 0) {
80103935:	c1 fa 03             	sar    $0x3,%edx
80103938:	89 55 e4             	mov    %edx,-0x1c(%ebp)
8010393b:	75 33                	jne    80103970 <power.part.0+0x90>
  if (b % 2 == 0) {
8010393d:	83 e1 01             	and    $0x1,%ecx
80103940:	75 1e                	jne    80103960 <power.part.0+0x80>
    return temp * temp;
80103942:	0f af c0             	imul   %eax,%eax
  if (b % 2 == 0) {
80103945:	83 e6 01             	and    $0x1,%esi
80103948:	75 06                	jne    80103950 <power.part.0+0x70>
    return temp * temp;
8010394a:	0f af c0             	imul   %eax,%eax
8010394d:	eb ae                	jmp    801038fd <power.part.0+0x1d>
8010394f:	90                   	nop
    return a * temp * temp;
80103950:	89 fa                	mov    %edi,%edx
80103952:	0f af d0             	imul   %eax,%edx
80103955:	0f af c2             	imul   %edx,%eax
80103958:	eb a3                	jmp    801038fd <power.part.0+0x1d>
8010395a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103960:	89 fa                	mov    %edi,%edx
80103962:	0f af d0             	imul   %eax,%edx
80103965:	0f af c2             	imul   %edx,%eax
80103968:	eb db                	jmp    80103945 <power.part.0+0x65>
8010396a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  int temp = power(a, b / 2);
80103970:	85 db                	test   %ebx,%ebx
80103972:	8d 53 0f             	lea    0xf(%ebx),%edx
80103975:	0f 49 d3             	cmovns %ebx,%edx
  if (b == 0) {
80103978:	c1 fa 04             	sar    $0x4,%edx
8010397b:	74 0d                	je     8010398a <power.part.0+0xaa>
8010397d:	89 f8                	mov    %edi,%eax
8010397f:	89 4d e0             	mov    %ecx,-0x20(%ebp)
80103982:	e8 59 ff ff ff       	call   801038e0 <power.part.0>
80103987:	8b 4d e0             	mov    -0x20(%ebp),%ecx
  if (b % 2 == 0) {
8010398a:	f6 45 e4 01          	testb  $0x1,-0x1c(%ebp)
8010398e:	75 08                	jne    80103998 <power.part.0+0xb8>
    return temp * temp;
80103990:	0f af c0             	imul   %eax,%eax
80103993:	eb a8                	jmp    8010393d <power.part.0+0x5d>
80103995:	8d 76 00             	lea    0x0(%esi),%esi
    return a * temp * temp;
80103998:	89 fa                	mov    %edi,%edx
8010399a:	0f af d0             	imul   %eax,%edx
8010399d:	0f af c2             	imul   %edx,%eax
801039a0:	eb 9b                	jmp    8010393d <power.part.0+0x5d>
...
801039b6:	68 c0 7f 10 80       	push   $0x80107fc0
801039bb:	68 20 2d 11 80       	push   $0x80112d20
801039c0:	e8 5b 12 00 00       	call   80104c20 <initlock>
}
...
801039dc:	e8 0f ef ff ff       	call   801028f0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
801039e1:	8b 35 84 27 11 80    	mov    0x80112784,%esi
...
801039fd:	0f b6 99 a0 27 11 80 	movzbl -0x7feed860(%ecx),%ebx
80103a04:	39 c3                	cmp    %eax,%ebx
80103a06:	75 e8                	jne    801039f0 <mycpu+0x20>
}
80103a08:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
80103a0b:	8d 81 a0 27 11 80    	lea    -0x7feed860(%ecx),%eax
}
80103a11:	5b                   	pop    %ebx
80103a12:	5e                   	pop    %esi
80103a13:	5d                   	pop    %ebp
...
80103a3b:	c9                   	leave  
  return mycpu()-cpus;
80103a3c:	2d a0 27 11 80       	sub    $0x801127a0,%eax
...
80103a54:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103a57:	e8 44 12 00 00       	call   80104ca0 <pushcli>
  c = mycpu();
80103a5c:	e8 6f ff ff ff       	call   801039d0 <mycpu>
  p = c->proc;
80103a61:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a67:	e8 84 12 00 00       	call   80104cf0 <popcli>
}
...
80103a84:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
80103a87:	e8 24 fd ff ff       	call   801037b0 <allocproc>
80103a8c:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103a8e:	a3 54 53 11 80       	mov    %eax,0x80115354
  if((p->pgdir = setupkvm()) == 0)
80103a93:	e8 88 3c 00 00       	call   80107720 <setupkvm>
80103a98:	89 43 04             	mov    %eax,0x4(%ebx)
80103a9b:	85 c0                	test   %eax,%eax
80103a9d:	0f 84 f1 00 00 00    	je     80103b94 <userinit+0x114>
...
80103ab1:	e8 1a 39 00 00       	call   801073d0 <inituvm>
...
80103ac6:	e8 e5 13 00 00       	call   80104eb0 <memset>
...
80103b1f:	68 f0 7f 10 80       	push   $0x80107ff0
80103b24:	50                   	push   %eax
80103b25:	e8 46 15 00 00       	call   80105070 <safestrcpy>
  p->cwd = namei("/");
80103b2a:	c7 04 24 f9 7f 10 80 	movl   $0x80107ff9,(%esp)
...
80103b40:	e8 ab 12 00 00       	call   80104df0 <acquire>
  p->state = RUNNABLE;
80103b45:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  p->sched_policy = -1;
80103b4c:	c7 83 94 00 00 00 ff 	movl   $0xffffffff,0x94(%ebx)
80103b53:	ff ff ff 
  p->elapsed_time = 0;
80103b56:	c7 83 88 00 00 00 00 	movl   $0x0,0x88(%ebx)
80103b5d:	00 00 00 
  acquire(&tickslock);
80103b60:	c7 04 24 80 53 11 80 	movl   $0x80115380,(%esp)
80103b67:	e8 84 12 00 00       	call   80104df0 <acquire>
  p->ctime = ticks;
80103b6c:	a1 60 53 11 80       	mov    0x80115360,%eax
80103b71:	89 43 7c             	mov    %eax,0x7c(%ebx)
  release(&tickslock);
80103b74:	c7 04 24 80 53 11 80 	movl   $0x80115380,(%esp)
80103b7b:	e8 10 12 00 00       	call   80104d90 <release>
  release(&ptable.lock);
80103b80:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103b87:	e8 04 12 00 00       	call   80104d90 <release>
}
...
80103b97:	68 d7 7f 10 80       	push   $0x80107fd7
...
80103bb5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103bb8:	e8 e3 10 00 00       	call   80104ca0 <pushcli>
  c = mycpu();
80103bbd:	e8 0e fe ff ff       	call   801039d0 <mycpu>
  p = c->proc;
80103bc2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bc8:	e8 23 11 00 00       	call   80104cf0 <popcli>
  sz = curproc->sz;
...
80103bdb:	e8 e0 36 00 00       	call   801072c0 <switchuvm>
  return 0;
...
80103bfa:	e8 41 39 00 00       	call   80107540 <allocuvm>
...
80103c1a:	e8 51 3a 00 00       	call   80107670 <deallocuvm>
...
80103cac:	e8 ef d1 ff ff       	call   80100ea0 <filedup>
...
80103cc9:	83 c3 6c             	add    $0x6c,%ebx
  np->cwd = idup(curproc->cwd);
80103ccc:	e8 7f da ff ff       	call   80101750 <idup>
...
80103ce1:	e8 8a 13 00 00       	call   80105070 <safestrcpy>
  pid = np->pid;
80103ce6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103ce9:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103cf0:	e8 fb 10 00 00       	call   80104df0 <acquire>
  np->state = RUNNABLE;
80103cf5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  np->sched_policy = -1;
80103cfc:	c7 87 94 00 00 00 ff 	movl   $0xffffffff,0x94(%edi)
80103d03:	ff ff ff 
  np->elapsed_time = 0;
80103d06:	c7 87 88 00 00 00 00 	movl   $0x0,0x88(%edi)
80103d0d:	00 00 00 
  acquire(&tickslock);
80103d10:	c7 04 24 80 53 11 80 	movl   $0x80115380,(%esp)
80103d17:	e8 d4 10 00 00       	call   80104df0 <acquire>
  np->ctime = ticks;
80103d1c:	a1 60 53 11 80       	mov    0x80115360,%eax
80103d21:	89 47 7c             	mov    %eax,0x7c(%edi)
  release(&tickslock);
80103d24:	c7 04 24 80 53 11 80 	movl   $0x80115380,(%esp)
80103d2b:	e8 60 10 00 00       	call   80104d90 <release>
  release(&ptable.lock);
80103d30:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d37:	e8 54 10 00 00       	call   80104d90 <release>
  return pid;
80103d3c:	83 c4 10             	add    $0x10,%esp
}
80103d3f:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
80103d48:	c3                   	ret    
    return -1;
80103d49:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103d4e:	eb ef                	jmp    80103d3f <fork+0x10f>
    kfree(np->kstack);
80103d50:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103d53:	83 ec 0c             	sub    $0xc,%esp
80103d56:	ff 73 08             	push   0x8(%ebx)
80103d59:	e8 62 e7 ff ff       	call   801024c0 <kfree>
    np->kstack = 0;
...
80103d68:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103d6f:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103d74:	eb c9                	jmp    80103d3f <fork+0x10f>
...
80103d86:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103d89:	e8 42 fc ff ff       	call   801039d0 <mycpu>
  c->proc = 0;
...
80103d9d:	eb 5b                	jmp    80103dfa <scheduler+0x7a>
80103d9f:	90                   	nop
      else if(p->sched_policy == RMS_SCHED) {
80103da0:	83 f8 01             	cmp    $0x1,%eax
80103da3:	0f 84 c9 00 00 00    	je     80103e72 <scheduler+0xf2>
        switchuvm(p);
80103da9:	83 ec 0c             	sub    $0xc,%esp
        c->proc = p;
80103dac:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
        switchuvm(p);
80103db2:	57                   	push   %edi
80103db3:	e8 08 35 00 00       	call   801072c0 <switchuvm>
        p->state = RUNNING;
80103db8:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
        swtch(&(c->scheduler), p->context);
80103dbf:	58                   	pop    %eax
80103dc0:	5a                   	pop    %edx
80103dc1:	ff 77 1c             	push   0x1c(%edi)
80103dc4:	56                   	push   %esi
80103dc5:	e8 01 13 00 00       	call   801050cb <swtch>
        switchkvm();
80103dca:	e8 e1 34 00 00       	call   801072b0 <switchkvm>
        c->proc = 0;
80103dcf:	83 c4 10             	add    $0x10,%esp
80103dd2:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103dd9:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ddc:	81 c7 98 00 00 00    	add    $0x98,%edi
80103de2:	81 ff 54 53 11 80    	cmp    $0x80115354,%edi
80103de8:	72 26                	jb     80103e10 <scheduler+0x90>
    release(&ptable.lock);
80103dea:	83 ec 0c             	sub    $0xc,%esp
80103ded:	68 20 2d 11 80       	push   $0x80112d20
80103df2:	e8 99 0f 00 00       	call   80104d90 <release>
    sti();
...
80103dfb:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103dfe:	bf 54 2d 11 80       	mov    $0x80112d54,%edi
    acquire(&ptable.lock);
80103e03:	68 20 2d 11 80       	push   $0x80112d20
80103e08:	e8 e3 0f 00 00       	call   80104df0 <acquire>
80103e0d:	83 c4 10             	add    $0x10,%esp
      if(p->state != RUNNABLE)
80103e10:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103e14:	75 c6                	jne    80103ddc <scheduler+0x5c>
      if(p->sched_policy == EDF_SCHED) {
80103e16:	8b 87 94 00 00 00    	mov    0x94(%edi),%eax
80103e1c:	85 c0                	test   %eax,%eax
80103e1e:	75 80                	jne    80103da0 <scheduler+0x20>
        for(p1 = ptable.proc; p1 < &ptable.proc[NPROC]; p1++){
80103e20:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
        struct proc *earliest = 0;
80103e25:	31 d2                	xor    %edx,%edx
80103e27:	eb 22                	jmp    80103e4b <scheduler+0xcb>
80103e29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103e30:	8b 8a 8c 00 00 00    	mov    0x8c(%edx),%ecx
80103e36:	39 88 8c 00 00 00    	cmp    %ecx,0x8c(%eax)
80103e3c:	0f 4c d0             	cmovl  %eax,%edx
        for(p1 = ptable.proc; p1 < &ptable.proc[NPROC]; p1++){
80103e3f:	05 98 00 00 00       	add    $0x98,%eax
80103e44:	3d 54 53 11 80       	cmp    $0x80115354,%eax
80103e49:	74 1d                	je     80103e68 <scheduler+0xe8>
          if(p1->state != RUNNABLE)
80103e4b:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103e4f:	75 ee                	jne    80103e3f <scheduler+0xbf>
          if(!earliest || p1->deadline < earliest->deadline)
80103e51:	85 d2                	test   %edx,%edx
80103e53:	75 db                	jne    80103e30 <scheduler+0xb0>
80103e55:	89 c2                	mov    %eax,%edx
        for(p1 = ptable.proc; p1 < &ptable.proc[NPROC]; p1++){
80103e57:	05 98 00 00 00       	add    $0x98,%eax
80103e5c:	3d 54 53 11 80       	cmp    $0x80115354,%eax
80103e61:	75 e8                	jne    80103e4b <scheduler+0xcb>
80103e63:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e67:	90                   	nop
        if(earliest != 0) {
80103e68:	85 d2                	test   %edx,%edx
80103e6a:	0f 45 fa             	cmovne %edx,%edi
80103e6d:	e9 37 ff ff ff       	jmp    80103da9 <scheduler+0x29>
        for(p1 = ptable.proc; p1 < &ptable.proc[NPROC]; p1++){
80103e72:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103e77:	eb 27                	jmp    80103ea0 <scheduler+0x120>
...
80103e80:	75 0e                	jne    80103e90 <scheduler+0x110>
80103e82:	8b 4f 10             	mov    0x10(%edi),%ecx
80103e85:	39 48 10             	cmp    %ecx,0x10(%eax)
80103e88:	0f 4c f8             	cmovl  %eax,%edi
80103e8b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e8f:	90                   	nop
        for(p1 = ptable.proc; p1 < &ptable.proc[NPROC]; p1++){
80103e90:	05 98 00 00 00       	add    $0x98,%eax
80103e95:	3d 54 53 11 80       	cmp    $0x80115354,%eax
80103e9a:	0f 84 09 ff ff ff    	je     80103da9 <scheduler+0x29>
          if(p1->state != RUNNABLE)
80103ea0:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103ea4:	75 ea                	jne    80103e90 <scheduler+0x110>
          if(!earliest || p1->weight < earliest->weight || ((p1->weight == earliest->weight) && (p1->pid < earliest->pid)))
80103ea6:	8b 8f 80 00 00 00    	mov    0x80(%edi),%ecx
80103eac:	39 88 80 00 00 00    	cmp    %ecx,0x80(%eax)
80103eb2:	7d cc                	jge    80103e80 <scheduler+0x100>
80103eb4:	89 c7                	mov    %eax,%edi
80103eb6:	eb d8                	jmp    80103e90 <scheduler+0x110>
...
80103ec4:	53                   	push   %ebx
  pushcli();
80103ec5:	e8 d6 0d 00 00       	call   80104ca0 <pushcli>
  c = mycpu();
80103eca:	e8 01 fb ff ff       	call   801039d0 <mycpu>
  p = c->proc;
80103ecf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ed5:	e8 16 0e 00 00       	call   80104cf0 <popcli>
  if(!holding(&ptable.lock))
80103eda:	83 ec 0c             	sub    $0xc,%esp
80103edd:	68 20 2d 11 80       	push   $0x80112d20
80103ee2:	e8 69 0e 00 00       	call   80104d50 <holding>
80103ee7:	83 c4 10             	add    $0x10,%esp
80103eea:	85 c0                	test   %eax,%eax
80103eec:	74 4f                	je     80103f3d <sched+0x7d>
  if(mycpu()->ncli != 1)
80103eee:	e8 dd fa ff ff       	call   801039d0 <mycpu>
...
80103f07:	75 41                	jne    80103f4a <sched+0x8a>
  intena = mycpu()->intena;
80103f09:	e8 c2 fa ff ff       	call   801039d0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103f0e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103f11:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103f17:	e8 b4 fa ff ff       	call   801039d0 <mycpu>
80103f1c:	83 ec 08             	sub    $0x8,%esp
80103f1f:	ff 70 04             	push   0x4(%eax)
80103f22:	53                   	push   %ebx
80103f23:	e8 a3 11 00 00       	call   801050cb <swtch>
  mycpu()->intena = intena;
80103f28:	e8 a3 fa ff ff       	call   801039d0 <mycpu>
}
...
80103f86:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103f89:	e8 c2 fa ff ff       	call   80103a50 <myproc>
  if(curproc == initproc)
80103f8e:	39 05 54 53 11 80    	cmp    %eax,0x80115354
80103f94:	0f 84 07 01 00 00    	je     801040a1 <exit+0x121>
...
80103fb2:	e8 39 cf ff ff       	call   80100ef0 <fileclose>
      curproc->ofile[fd] = 0;
...
80103fc5:	75 e1                	jne    80103fa8 <exit+0x28>
  begin_op();
80103fc7:	e8 94 ed ff ff       	call   80102d60 <begin_op>
  iput(curproc->cwd);
80103fcc:	83 ec 0c             	sub    $0xc,%esp
80103fcf:	ff 73 68             	push   0x68(%ebx)
80103fd2:	e8 d9 d8 ff ff       	call   801018b0 <iput>
  end_op();
80103fd7:	e8 f4 ed ff ff       	call   80102dd0 <end_op>
  curproc->cwd = 0;
80103fdc:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103fe3:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103fea:	e8 01 0e 00 00       	call   80104df0 <acquire>
  wakeup1(curproc->parent);
80103fef:	8b 53 14             	mov    0x14(%ebx),%edx
80103ff2:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ff5:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103ffa:	eb 10                	jmp    8010400c <exit+0x8c>
80103ffc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104000:	05 98 00 00 00       	add    $0x98,%eax
80104005:	3d 54 53 11 80       	cmp    $0x80115354,%eax
8010400a:	74 1e                	je     8010402a <exit+0xaa>
    if(p->state == SLEEPING && p->chan == chan)
8010400c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80104010:	75 ee                	jne    80104000 <exit+0x80>
80104012:	3b 50 20             	cmp    0x20(%eax),%edx
80104015:	75 e9                	jne    80104000 <exit+0x80>
      p->state = RUNNABLE;
80104017:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010401e:	05 98 00 00 00       	add    $0x98,%eax
80104023:	3d 54 53 11 80       	cmp    $0x80115354,%eax
80104028:	75 e2                	jne    8010400c <exit+0x8c>
      p->parent = initproc;
8010402a:	8b 0d 54 53 11 80    	mov    0x80115354,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104030:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80104035:	eb 17                	jmp    8010404e <exit+0xce>
80104037:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010403e:	66 90                	xchg   %ax,%ax
80104040:	81 c2 98 00 00 00    	add    $0x98,%edx
80104046:	81 fa 54 53 11 80    	cmp    $0x80115354,%edx
8010404c:	74 3a                	je     80104088 <exit+0x108>
    if(p->parent == curproc){
8010404e:	39 5a 14             	cmp    %ebx,0x14(%edx)
80104051:	75 ed                	jne    80104040 <exit+0xc0>
      if(p->state == ZOMBIE)
80104053:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
      p->parent = initproc;
80104057:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
8010405a:	75 e4                	jne    80104040 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010405c:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104061:	eb 11                	jmp    80104074 <exit+0xf4>
80104063:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104067:	90                   	nop
80104068:	05 98 00 00 00       	add    $0x98,%eax
8010406d:	3d 54 53 11 80       	cmp    $0x80115354,%eax
80104072:	74 cc                	je     80104040 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
80104074:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80104078:	75 ee                	jne    80104068 <exit+0xe8>
8010407a:	3b 48 20             	cmp    0x20(%eax),%ecx
8010407d:	75 e9                	jne    80104068 <exit+0xe8>
      p->state = RUNNABLE;
8010407f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80104086:	eb e0                	jmp    80104068 <exit+0xe8>
...
80104097:	68 48 80 10 80       	push   $0x80108048
8010409c:	e8 df c2 ff ff       	call   80100380 <panic>
    panic("init exiting");
801040a1:	83 ec 0c             	sub    $0xc,%esp
801040a4:	68 3b 80 10 80       	push   $0x8010803b
...
801040b4:	53                   	push   %ebx
  pushcli();
801040b5:	e8 e6 0b 00 00       	call   80104ca0 <pushcli>
  c = mycpu();
801040ba:	e8 11 f9 ff ff       	call   801039d0 <mycpu>
  p = c->proc;
801040bf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801040c5:	e8 26 0c 00 00       	call   80104cf0 <popcli>
  acquire(&ptable.lock);
801040ca:	83 ec 0c             	sub    $0xc,%esp
801040cd:	68 20 2d 11 80       	push   $0x80112d20
801040d2:	e8 19 0d 00 00       	call   80104df0 <acquire>
801040d7:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
801040da:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040dc:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
801040e1:	eb 13                	jmp    801040f6 <wait+0x46>
801040e3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801040e7:	90                   	nop
801040e8:	81 c3 98 00 00 00    	add    $0x98,%ebx
801040ee:	81 fb 54 53 11 80    	cmp    $0x80115354,%ebx
801040f4:	74 1e                	je     80104114 <wait+0x64>
      if(p->parent != curproc)
801040f6:	39 73 14             	cmp    %esi,0x14(%ebx)
801040f9:	75 ed                	jne    801040e8 <wait+0x38>
      if(p->state == ZOMBIE){
801040fb:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
801040ff:	74 5f                	je     80104160 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104101:	81 c3 98 00 00 00    	add    $0x98,%ebx
      havekids = 1;
80104107:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010410c:	81 fb 54 53 11 80    	cmp    $0x80115354,%ebx
80104112:	75 e2                	jne    801040f6 <wait+0x46>
    if(!havekids || curproc->killed){
80104114:	85 c0                	test   %eax,%eax
80104116:	0f 84 9a 00 00 00    	je     801041b6 <wait+0x106>
8010411c:	8b 46 24             	mov    0x24(%esi),%eax
8010411f:	85 c0                	test   %eax,%eax
80104121:	0f 85 8f 00 00 00    	jne    801041b6 <wait+0x106>
  pushcli();
80104127:	e8 74 0b 00 00       	call   80104ca0 <pushcli>
  c = mycpu();
8010412c:	e8 9f f8 ff ff       	call   801039d0 <mycpu>
  p = c->proc;
80104131:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104137:	e8 b4 0b 00 00       	call   80104cf0 <popcli>
  if(p == 0)
8010413c:	85 db                	test   %ebx,%ebx
8010413e:	0f 84 89 00 00 00    	je     801041cd <wait+0x11d>
  p->chan = chan;
80104144:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
80104147:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
8010414e:	e8 6d fd ff ff       	call   80103ec0 <sched>
  p->chan = 0;
80104153:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
8010415a:	e9 7b ff ff ff       	jmp    801040da <wait+0x2a>
8010415f:	90                   	nop
        kfree(p->kstack);
...
80104169:	e8 52 e3 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
8010416e:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104175:	5a                   	pop    %edx
80104176:	ff 73 04             	push   0x4(%ebx)
80104179:	e8 22 35 00 00       	call   801076a0 <freevm>
        p->pid = 0;
...
801041a5:	e8 e6 0b 00 00       	call   80104d90 <release>
        return pid;
...
801041ec:	e8 ff 0b 00 00       	call   80104df0 <acquire>
  pushcli();
801041f1:	e8 aa 0a 00 00       	call   80104ca0 <pushcli>
  c = mycpu();
801041f6:	e8 d5 f7 ff ff       	call   801039d0 <mycpu>
  p = c->proc;
801041fb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104201:	e8 ea 0a 00 00       	call   80104cf0 <popcli>
...
80104219:	e8 72 0b 00 00       	call   80104d90 <release>
}
...
8010423c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010423f:	e8 5c 0a 00 00       	call   80104ca0 <pushcli>
  c = mycpu();
80104244:	e8 87 f7 ff ff       	call   801039d0 <mycpu>
  p = c->proc;
80104249:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010424f:	e8 9c 0a 00 00       	call   80104cf0 <popcli>
  if(p == 0)
...
80104270:	e8 7b 0b 00 00       	call   80104df0 <acquire>
    release(lk);
80104275:	89 34 24             	mov    %esi,(%esp)
80104278:	e8 13 0b 00 00       	call   80104d90 <release>
  p->chan = chan;
...
8010429a:	e8 f1 0a 00 00       	call   80104d90 <release>
    acquire(lk);
...
801042ab:	5d                   	pop    %ebp
    acquire(lk);
801042ac:	e9 3f 0b 00 00       	jmp    80104df0 <acquire>
...
801042d9:	68 5a 80 10 80       	push   $0x8010805a
801042de:	e8 9d c0 ff ff       	call   80100380 <panic>
    panic("sleep");
801042e3:	83 ec 0c             	sub    $0xc,%esp
801042e6:	68 54 80 10 80       	push   $0x80108054
...
801042ff:	e8 ec 0a 00 00       	call   80104df0 <acquire>
...
80104310:	05 98 00 00 00       	add    $0x98,%eax
80104315:	3d 54 53 11 80       	cmp    $0x80115354,%eax
...
80104327:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010432e:	05 98 00 00 00       	add    $0x98,%eax
80104333:	3d 54 53 11 80       	cmp    $0x80115354,%eax
80104338:	75 e2                	jne    8010431c <wakeup+0x2c>
  release(&ptable.lock);
8010433a:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
80104341:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104344:	c9                   	leave  
  release(&ptable.lock);
80104345:	e9 46 0a 00 00       	jmp    80104d90 <release>
...
8010435f:	e8 8c 0a 00 00       	call   80104df0 <acquire>
...
80104370:	05 98 00 00 00       	add    $0x98,%eax
80104375:	3d 54 53 11 80       	cmp    $0x80115354,%eax
8010437a:	74 34                	je     801043b0 <kill+0x60>
    if(p->pid == pid){
...
80104385:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
8010438c:	75 07                	jne    80104395 <kill+0x45>
        p->state = RUNNABLE;
8010438e:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104395:	83 ec 0c             	sub    $0xc,%esp
80104398:	68 20 2d 11 80       	push   $0x80112d20
8010439d:	e8 ee 09 00 00       	call   80104d90 <release>
}
...
801043b8:	e8 d3 09 00 00       	call   80104d90 <release>
}
...
801043d9:	bb c0 2d 11 80       	mov    $0x80112dc0,%ebx
801043de:	83 ec 3c             	sub    $0x3c,%esp
801043e1:	eb 27                	jmp    8010440a <procdump+0x3a>
801043e3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801043e7:	90                   	nop
    cprintf("\n");
801043e8:	83 ec 0c             	sub    $0xc,%esp
801043eb:	68 0b 84 10 80       	push   $0x8010840b
801043f0:	e8 ab c2 ff ff       	call   801006a0 <cprintf>
801043f5:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043f8:	81 c3 98 00 00 00    	add    $0x98,%ebx
801043fe:	81 fb c0 53 11 80    	cmp    $0x801153c0,%ebx
80104404:	0f 84 7e 00 00 00    	je     80104488 <procdump+0xb8>
    if(p->state == UNUSED)
8010440a:	8b 43 a0             	mov    -0x60(%ebx),%eax
8010440d:	85 c0                	test   %eax,%eax
8010440f:	74 e7                	je     801043f8 <procdump+0x28>
      state = "???";
80104411:	ba 6b 80 10 80       	mov    $0x8010806b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104416:	83 f8 05             	cmp    $0x5,%eax
80104419:	77 11                	ja     8010442c <procdump+0x5c>
8010441b:	8b 14 85 cc 80 10 80 	mov    -0x7fef7f34(,%eax,4),%edx
      state = "???";
80104422:	b8 6b 80 10 80       	mov    $0x8010806b,%eax
80104427:	85 d2                	test   %edx,%edx
80104429:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
8010442c:	53                   	push   %ebx
8010442d:	52                   	push   %edx
8010442e:	ff 73 a4             	push   -0x5c(%ebx)
80104431:	68 6f 80 10 80       	push   $0x8010806f
80104436:	e8 65 c2 ff ff       	call   801006a0 <cprintf>
    if(p->state == SLEEPING){
8010443b:	83 c4 10             	add    $0x10,%esp
8010443e:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
80104442:	75 a4                	jne    801043e8 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104444:	83 ec 08             	sub    $0x8,%esp
80104447:	8d 45 c0             	lea    -0x40(%ebp),%eax
8010444a:	8d 7d c0             	lea    -0x40(%ebp),%edi
8010444d:	50                   	push   %eax
8010444e:	8b 43 b0             	mov    -0x50(%ebx),%eax
80104451:	8b 40 0c             	mov    0xc(%eax),%eax
80104454:	83 c0 08             	add    $0x8,%eax
80104457:	50                   	push   %eax
80104458:	e8 e3 07 00 00       	call   80104c40 <getcallerpcs>
...
8010446d:	68 c1 7a 10 80       	push   $0x80107ac1
...
80104490 <update_proc_stats>:
update_proc_stats() {
80104490:	55                   	push   %ebp
80104491:	89 e5                	mov    %esp,%ebp
80104493:	83 ec 14             	sub    $0x14,%esp
  acquire(&ptable.lock);
80104496:	68 20 2d 11 80       	push   $0x80112d20
8010449b:	e8 50 09 00 00       	call   80104df0 <acquire>
801044a0:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801044a3:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801044a8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801044af:	90                   	nop
    if (p->state == RUNNING) {
801044b0:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801044b4:	75 07                	jne    801044bd <update_proc_stats+0x2d>
        p->elapsed_time++;
801044b6:	83 80 88 00 00 00 01 	addl   $0x1,0x88(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801044bd:	05 98 00 00 00       	add    $0x98,%eax
801044c2:	3d 54 53 11 80       	cmp    $0x80115354,%eax
801044c7:	75 e7                	jne    801044b0 <update_proc_stats+0x20>
  release(&ptable.lock);
801044c9:	83 ec 0c             	sub    $0xc,%esp
801044cc:	68 20 2d 11 80       	push   $0x80112d20
801044d1:	e8 ba 08 00 00       	call   80104d90 <release>
  return;
...
801044e8:	57                   	push   %edi
801044e9:	56                   	push   %esi
801044ea:	53                   	push   %ebx
801044eb:	83 ec 0c             	sub    $0xc,%esp
801044ee:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  if (b == 0) {
801044f1:	85 db                	test   %ebx,%ebx
801044f3:	75 0b                	jne    80104500 <power+0x20>
}
801044f5:	83 c4 0c             	add    $0xc,%esp
801044f8:	5b                   	pop    %ebx
801044f9:	5e                   	pop    %esi
801044fa:	5f                   	pop    %edi
801044fb:	5d                   	pop    %ebp
...
801044fd:	8d 76 00             	lea    0x0(%esi),%esi
  int temp = power(a, b / 2);
80104500:	89 de                	mov    %ebx,%esi
80104502:	c1 ee 1f             	shr    $0x1f,%esi
80104505:	01 de                	add    %ebx,%esi
  if (b == 0) {
80104507:	d1 fe                	sar    %esi
80104509:	74 15                	je     80104520 <power+0x40>
  int temp = power(a, b / 2);
8010450b:	85 db                	test   %ebx,%ebx
8010450d:	8d 7b 03             	lea    0x3(%ebx),%edi
80104510:	0f 49 fb             	cmovns %ebx,%edi
  if (b == 0) {
80104513:	c1 ff 02             	sar    $0x2,%edi
80104516:	75 40                	jne    80104558 <power+0x78>
  if (b % 2 == 0) {
80104518:	83 e6 01             	and    $0x1,%esi
8010451b:	75 2b                	jne    80104548 <power+0x68>
    return temp * temp;
8010451d:	0f af c0             	imul   %eax,%eax
  if (b % 2 == 0) {
80104520:	83 e3 01             	and    $0x1,%ebx
80104523:	75 0b                	jne    80104530 <power+0x50>
}
80104525:	83 c4 0c             	add    $0xc,%esp
    return temp * temp;
80104528:	0f af c0             	imul   %eax,%eax
}
8010452b:	5b                   	pop    %ebx
8010452c:	5e                   	pop    %esi
8010452d:	5f                   	pop    %edi
...
8010452f:	c3                   	ret    
    return a * temp * temp;
80104530:	8b 55 08             	mov    0x8(%ebp),%edx
}
80104533:	83 c4 0c             	add    $0xc,%esp
80104536:	5b                   	pop    %ebx
80104537:	5e                   	pop    %esi
    return a * temp * temp;
80104538:	0f af d0             	imul   %eax,%edx
}
8010453b:	5f                   	pop    %edi
8010453c:	5d                   	pop    %ebp
    return a * temp * temp;
8010453d:	0f af c2             	imul   %edx,%eax
}
80104540:	c3                   	ret    
80104541:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    return a * temp * temp;
80104548:	8b 55 08             	mov    0x8(%ebp),%edx
8010454b:	0f af d0             	imul   %eax,%edx
8010454e:	0f af c2             	imul   %edx,%eax
80104551:	eb cd                	jmp    80104520 <power+0x40>
80104553:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104557:	90                   	nop
  int temp = power(a, b / 2);
80104558:	85 db                	test   %ebx,%ebx
8010455a:	8d 53 07             	lea    0x7(%ebx),%edx
8010455d:	0f 49 d3             	cmovns %ebx,%edx
  if (b == 0) {
80104560:	c1 fa 03             	sar    $0x3,%edx
80104563:	74 08                	je     8010456d <power+0x8d>
80104565:	8b 45 08             	mov    0x8(%ebp),%eax
80104568:	e8 73 f3 ff ff       	call   801038e0 <power.part.0>
  if (b % 2 == 0) {
8010456d:	83 e7 01             	and    $0x1,%edi
80104570:	75 0e                	jne    80104580 <power+0xa0>
    return temp * temp;
80104572:	0f af c0             	imul   %eax,%eax
80104575:	eb a1                	jmp    80104518 <power+0x38>
80104577:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010457e:	66 90                	xchg   %ax,%ax
    return a * temp * temp;
80104580:	8b 55 08             	mov    0x8(%ebp),%edx
80104583:	0f af d0             	imul   %eax,%edx
80104586:	0f af c2             	imul   %edx,%eax
80104589:	eb 8d                	jmp    80104518 <power+0x38>
8010458b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010458f:	90                   	nop

80104590 <edf_schedulable>:

int
edf_schedulable(int pid) {
...
80104595:	53                   	push   %ebx
  ...
  int numerator = 0;
  int denominator = 1;
80104596:	bb 01 00 00 00       	mov    $0x1,%ebx
edf_schedulable(int pid) {
8010459b:	83 ec 18             	sub    $0x18,%esp
8010459e:	8b 75 08             	mov    0x8(%ebp),%esi
...
801045ab:	83 c4 10             	add    $0x10,%esp
  ...
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801045ae:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801045b3:	eb 14                	jmp    801045c9 <edf_schedulable+0x39>
801045b5:	8d 76 00             	lea    0x0(%esi),%esi
    if (p->state == RUNNABLE && p->sched_policy == EDF_SCHED) {
      count++;
      denominator *= p->deadline;
    } else if(p->pid == pid) {
801045b8:	39 70 10             	cmp    %esi,0x10(%eax)
801045bb:	74 1c                	je     801045d9 <edf_schedulable+0x49>
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801045bd:	05 98 00 00 00       	add    $0x98,%eax
801045c2:	3d 54 53 11 80       	cmp    $0x80115354,%eax
801045c7:	74 23                	je     801045ec <edf_schedulable+0x5c>
    if (p->state == RUNNABLE && p->sched_policy == EDF_SCHED) {
801045c9:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
801045cd:	75 e9                	jne    801045b8 <edf_schedulable+0x28>
801045cf:	8b 90 94 00 00 00    	mov    0x94(%eax),%edx
801045d5:	85 d2                	test   %edx,%edx
801045d7:	75 df                	jne    801045b8 <edf_schedulable+0x28>
      denominator *= p->deadline;
801045d9:	0f af 98 8c 00 00 00 	imul   0x8c(%eax),%ebx
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801045e0:	05 98 00 00 00       	add    $0x98,%eax
801045e5:	3d 54 53 11 80       	cmp    $0x80115354,%eax
801045ea:	75 dd                	jne    801045c9 <edf_schedulable+0x39>
  int numerator = 0;
801045ec:	31 ff                	xor    %edi,%edi
      
    }
  }
  // cprintf("Count for pid %d = %d\n",pid,count);
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801045ee:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
801045f3:	eb 16                	jmp    8010460b <edf_schedulable+0x7b>
...
801045f8:	39 71 10             	cmp    %esi,0x10(%ecx)
801045fb:	74 1e                	je     8010461b <edf_schedulable+0x8b>
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801045fd:	81 c1 98 00 00 00    	add    $0x98,%ecx
80104603:	81 f9 54 53 11 80    	cmp    $0x80115354,%ecx
80104609:	74 2d                	je     80104638 <edf_schedulable+0xa8>
    if (p->state == RUNNABLE && p->sched_policy == EDF_SCHED) {
8010460b:	83 79 0c 03          	cmpl   $0x3,0xc(%ecx)
8010460f:	75 e7                	jne    801045f8 <edf_schedulable+0x68>
80104611:	8b 81 94 00 00 00    	mov    0x94(%ecx),%eax
80104617:	85 c0                	test   %eax,%eax
80104619:	75 dd                	jne    801045f8 <edf_schedulable+0x68>
      // cprintf("%d\n",p->deadline - (ticks_now - p->ctime));
      numerator += p->exec_time*(denominator/p->deadline);
8010461b:	89 d8                	mov    %ebx,%eax
8010461d:	99                   	cltd   
8010461e:	f7 b9 8c 00 00 00    	idivl  0x8c(%ecx)
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104624:	81 c1 98 00 00 00    	add    $0x98,%ecx
      numerator += p->exec_time*(denominator/p->deadline);
8010462a:	0f af 41 ec          	imul   -0x14(%ecx),%eax
8010462e:	01 c7                	add    %eax,%edi
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104630:	81 f9 54 53 11 80    	cmp    $0x80115354,%ecx
80104636:	75 d3                	jne    8010460b <edf_schedulable+0x7b>
    }
  }
  
  release(&ptable.lock);
80104638:	83 ec 0c             	sub    $0xc,%esp
8010463b:	68 20 2d 11 80       	push   $0x80112d20
80104640:	e8 4b 07 00 00       	call   80104d90 <release>
...
80104648:	b8 ea ff ff ff       	mov    $0xffffffea,%eax
8010464d:	39 df                	cmp    %ebx,%edi
8010464f:	ba 00 00 00 00       	mov    $0x0,%edx
80104654:	0f 4e c2             	cmovle %edx,%eax
  // if (total_util <= 1) {
  //   return 0; // System is schedulable under EDF
  // }
...
int rms_schedulable(int pid){
8010466a:	83 ec 28             	sub    $0x28,%esp
8010466d:	8b 7d 08             	mov    0x8(%ebp),%edi
  acquire(&ptable.lock);
80104670:	68 20 2d 11 80       	push   $0x80112d20
80104675:	e8 76 07 00 00       	call   80104df0 <acquire>
8010467a:	83 c4 10             	add    $0x10,%esp
  ...
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
8010467d:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104682:	eb 15                	jmp    80104699 <rms_schedulable+0x39>
80104684:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if (p->state == RUNNABLE && p->sched_policy == RMS_SCHED) {
      n++;
      numerator += p->exec_time*(p->rate);
    } else if(p->pid == pid) {
80104688:	39 78 10             	cmp    %edi,0x10(%eax)
8010468b:	74 1b                	je     801046a8 <rms_schedulable+0x48>
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
8010468d:	05 98 00 00 00       	add    $0x98,%eax
80104692:	3d 54 53 11 80       	cmp    $0x80115354,%eax
80104697:	74 2d                	je     801046c6 <rms_schedulable+0x66>
    if (p->state == RUNNABLE && p->sched_policy == RMS_SCHED) {
80104699:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
8010469d:	75 e9                	jne    80104688 <rms_schedulable+0x28>
8010469f:	83 b8 94 00 00 00 01 	cmpl   $0x1,0x94(%eax)
801046a6:	75 e0                	jne    80104688 <rms_schedulable+0x28>
      n++;
      numerator += p->exec_time*(p->rate);
801046a8:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
801046ae:	0f af 90 90 00 00 00 	imul   0x90(%eax),%edx
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801046b5:	05 98 00 00 00       	add    $0x98,%eax
      n++;
801046ba:	83 c3 01             	add    $0x1,%ebx
      numerator += p->exec_time*(p->rate);
801046bd:	01 d6                	add    %edx,%esi
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801046bf:	3d 54 53 11 80       	cmp    $0x80115354,%eax
801046c4:	75 d3                	jne    80104699 <rms_schedulable+0x39>
  if (b == 0) {
801046c6:	85 db                	test   %ebx,%ebx
801046c8:	75 1a                	jne    801046e4 <rms_schedulable+0x84>

  numerator = power(numerator,n);
  denominator = power(denominator,n);
  // cprintf("Num = %d, Deno = %d\n", numerator, denominator);

  release(&ptable.lock);
801046ca:	83 ec 0c             	sub    $0xc,%esp
801046cd:	68 20 2d 11 80       	push   $0x80112d20
801046d2:	e8 b9 06 00 00       	call   80104d90 <release>
...
801046e3:	c3                   	ret    
  denominator*=n*100;
801046e4:	6b fb 64             	imul   $0x64,%ebx,%edi
  if (b == 0) {
801046e7:	89 d9                	mov    %ebx,%ecx
  numerator += denominator;
801046e9:	01 fe                	add    %edi,%esi
  if (b == 0) {
801046eb:	d1 f9                	sar    %ecx
801046ed:	74 5f                	je     8010474e <rms_schedulable+0xee>
801046ef:	89 da                	mov    %ebx,%edx
    return 1;
801046f1:	b8 01 00 00 00       	mov    $0x1,%eax
  if (b == 0) {
801046f6:	c1 fa 02             	sar    $0x2,%edx
801046f9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801046fc:	0f 85 8d 00 00 00    	jne    8010478f <rms_schedulable+0x12f>
  if (b % 2 == 0) {
80104702:	f6 c1 01             	test   $0x1,%cl
80104705:	74 73                	je     8010477a <rms_schedulable+0x11a>
    return a * temp * temp;
80104707:	89 f2                	mov    %esi,%edx
80104709:	0f af d0             	imul   %eax,%edx
8010470c:	0f af c2             	imul   %edx,%eax
  if (b % 2 == 0) {
8010470f:	89 da                	mov    %ebx,%edx
80104711:	83 e2 01             	and    $0x1,%edx
80104714:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80104717:	75 6e                	jne    80104787 <rms_schedulable+0x127>
    return temp * temp;
80104719:	0f af c0             	imul   %eax,%eax
8010471c:	89 c6                	mov    %eax,%esi
  if (b == 0) {
8010471e:	c1 fb 02             	sar    $0x2,%ebx
    return 1;
80104721:	b8 01 00 00 00       	mov    $0x1,%eax
  if (b == 0) {
80104726:	74 0f                	je     80104737 <rms_schedulable+0xd7>
80104728:	89 da                	mov    %ebx,%edx
8010472a:	89 f8                	mov    %edi,%eax
8010472c:	89 4d e0             	mov    %ecx,-0x20(%ebp)
8010472f:	e8 ac f1 ff ff       	call   801038e0 <power.part.0>
80104734:	8b 4d e0             	mov    -0x20(%ebp),%ecx
  if (b % 2 == 0) {
80104737:	83 e1 01             	and    $0x1,%ecx
8010473a:	75 7c                	jne    801047b8 <rms_schedulable+0x158>
    return temp * temp;
8010473c:	0f af c0             	imul   %eax,%eax
8010473f:	89 c3                	mov    %eax,%ebx
  if (b % 2 == 0) {
80104741:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104744:	85 c0                	test   %eax,%eax
80104746:	74 69                	je     801047b1 <rms_schedulable+0x151>
    return a * temp * temp;
80104748:	0f af fb             	imul   %ebx,%edi
8010474b:	0f af fb             	imul   %ebx,%edi
  if (numerator <= 2*denominator) {
8010474e:	8d 1c 3f             	lea    (%edi,%edi,1),%ebx
  release(&ptable.lock);
80104751:	83 ec 0c             	sub    $0xc,%esp
80104754:	68 20 2d 11 80       	push   $0x80112d20
80104759:	e8 32 06 00 00       	call   80104d90 <release>
  if (numerator <= 2*denominator) {
8010475e:	83 c4 10             	add    $0x10,%esp
    return 0; // System is schedulable under EDF
80104761:	b8 00 00 00 00       	mov    $0x0,%eax
80104766:	39 f3                	cmp    %esi,%ebx
80104768:	bb ea ff ff ff       	mov    $0xffffffea,%ebx
8010476d:	0f 4d d8             	cmovge %eax,%ebx
}
80104770:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104773:	89 d8                	mov    %ebx,%eax
80104775:	5b                   	pop    %ebx
80104776:	5e                   	pop    %esi
80104777:	5f                   	pop    %edi
80104778:	5d                   	pop    %ebp
80104779:	c3                   	ret    
  if (b % 2 == 0) {
8010477a:	89 da                	mov    %ebx,%edx
    return temp * temp;
8010477c:	0f af c0             	imul   %eax,%eax
  if (b % 2 == 0) {
8010477f:	83 e2 01             	and    $0x1,%edx
80104782:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80104785:	74 92                	je     80104719 <rms_schedulable+0xb9>
    return a * temp * temp;
80104787:	0f af f0             	imul   %eax,%esi
8010478a:	0f af f0             	imul   %eax,%esi
  if (b == 0) {
8010478d:	eb 8f                	jmp    8010471e <rms_schedulable+0xbe>
8010478f:	89 da                	mov    %ebx,%edx
80104791:	c1 fa 03             	sar    $0x3,%edx
80104794:	74 0d                	je     801047a3 <rms_schedulable+0x143>
80104796:	89 f0                	mov    %esi,%eax
80104798:	89 4d e0             	mov    %ecx,-0x20(%ebp)
8010479b:	e8 40 f1 ff ff       	call   801038e0 <power.part.0>
801047a0:	8b 4d e0             	mov    -0x20(%ebp),%ecx
  if (b % 2 == 0) {
801047a3:	f6 45 e4 01          	testb  $0x1,-0x1c(%ebp)
801047a7:	75 1e                	jne    801047c7 <rms_schedulable+0x167>
    return temp * temp;
801047a9:	0f af c0             	imul   %eax,%eax
801047ac:	e9 51 ff ff ff       	jmp    80104702 <rms_schedulable+0xa2>
801047b1:	0f af db             	imul   %ebx,%ebx
  if (numerator <= 2*denominator) {
801047b4:	01 db                	add    %ebx,%ebx
    return temp * temp;
801047b6:	eb 99                	jmp    80104751 <rms_schedulable+0xf1>
    return a * temp * temp;
801047b8:	89 fa                	mov    %edi,%edx
801047ba:	0f af d0             	imul   %eax,%edx
801047bd:	89 d3                	mov    %edx,%ebx
801047bf:	0f af d8             	imul   %eax,%ebx
801047c2:	e9 7a ff ff ff       	jmp    80104741 <rms_schedulable+0xe1>
801047c7:	89 f2                	mov    %esi,%edx
801047c9:	0f af d0             	imul   %eax,%edx
801047cc:	0f af c2             	imul   %edx,%eax
801047cf:	e9 2e ff ff ff       	jmp    80104702 <rms_schedulable+0xa2>
801047d4:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801047db:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801047df:	90                   	nop

801047e0 <sched_policy_helper>:


int
sched_policy_helper(void)
{
...
801047e4:	8d 45 f0             	lea    -0x10(%ebp),%eax
{
801047e7:	83 ec 1c             	sub    $0x1c,%esp
  if(argint(0,&pid) < 0 || argint(1,&policy) < 0 ){
801047ea:	50                   	push   %eax
801047eb:	6a 00                	push   $0x0
801047ed:	e8 7e 09 00 00       	call   80105170 <argint>
801047f2:	83 c4 10             	add    $0x10,%esp
801047f5:	85 c0                	test   %eax,%eax
801047f7:	0f 88 83 00 00 00    	js     80104880 <sched_policy_helper+0xa0>
801047fd:	83 ec 08             	sub    $0x8,%esp
80104800:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104803:	50                   	push   %eax
80104804:	6a 01                	push   $0x1
80104806:	e8 65 09 00 00       	call   80105170 <argint>
8010480b:	83 c4 10             	add    $0x10,%esp
8010480e:	85 c0                	test   %eax,%eax
80104810:	78 6e                	js     80104880 <sched_policy_helper+0xa0>
    return -22;
  }
  struct proc *p;
  int f = 0;
...
8010481a:	e8 d1 05 00 00       	call   80104df0 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == pid){
8010481f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104822:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104825:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
8010482a:	eb 10                	jmp    8010483c <sched_policy_helper+0x5c>
8010482c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104830:	05 98 00 00 00       	add    $0x98,%eax
80104835:	3d 54 53 11 80       	cmp    $0x80115354,%eax
8010483a:	74 34                	je     80104870 <sched_policy_helper+0x90>
    if(p->pid == pid){
8010483c:	39 50 10             	cmp    %edx,0x10(%eax)
8010483f:	75 ef                	jne    80104830 <sched_policy_helper+0x50>
      f = 1;
...
80104844:	83 ec 0c             	sub    $0xc,%esp
      p->sched_policy = policy;
80104847:	89 90 94 00 00 00    	mov    %edx,0x94(%eax)
  release(&ptable.lock);
8010484d:	68 20 2d 11 80       	push   $0x80112d20
80104852:	e8 39 05 00 00       	call   80104d90 <release>
...
8010485f:	74 2f                	je     80104890 <sched_policy_helper+0xb0>
  ...
  return 0;
80104861:	31 db                	xor    %ebx,%ebx
  } else if(policy == RMS_SCHED) {
80104863:	83 f8 01             	cmp    $0x1,%eax
80104866:	74 4d                	je     801048b5 <sched_policy_helper+0xd5>
  
  // return 0;
}
80104868:	89 d8                	mov    %ebx,%eax
...
80104878:	e8 13 05 00 00       	call   80104d90 <release>
  if(!f)
8010487d:	83 c4 10             	add    $0x10,%esp
    return -22;
80104880:	bb ea ff ff ff       	mov    $0xffffffea,%ebx
}
...
80104893:	ff 75 f0             	push   -0x10(%ebp)
80104896:	e8 f5 fc ff ff       	call   80104590 <edf_schedulable>
    if( sched_result == -22){
8010489b:	83 c4 10             	add    $0x10,%esp
    int sched_result = edf_schedulable(pid);
8010489e:	89 c3                	mov    %eax,%ebx
    if( sched_result == -22){
801048a0:	83 f8 ea             	cmp    $0xffffffea,%eax
801048a3:	75 c3                	jne    80104868 <sched_policy_helper+0x88>
      kill(pid);
801048a5:	83 ec 0c             	sub    $0xc,%esp
801048a8:	ff 75 f0             	push   -0x10(%ebp)
801048ab:	e8 a0 fa ff ff       	call   80104350 <kill>
801048b0:	83 c4 10             	add    $0x10,%esp
801048b3:	eb b3                	jmp    80104868 <sched_policy_helper+0x88>
    int sched_result = rms_schedulable(pid);
801048b5:	83 ec 0c             	sub    $0xc,%esp
801048b8:	ff 75 f0             	push   -0x10(%ebp)
801048bb:	e8 a0 fd ff ff       	call   80104660 <rms_schedulable>
    if( sched_result == -22){
801048c0:	83 c4 10             	add    $0x10,%esp
    int sched_result = rms_schedulable(pid);
801048c3:	89 c3                	mov    %eax,%ebx
    if( sched_result == -22){
801048c5:	83 f8 ea             	cmp    $0xffffffea,%eax
801048c8:	75 9e                	jne    80104868 <sched_policy_helper+0x88>
801048ca:	eb d9                	jmp    801048a5 <sched_policy_helper+0xc5>
801048cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

801048d0 <exec_time_helper>:

int
exec_time_helper(void)
{
...
801048d6:	8d 45 f0             	lea    -0x10(%ebp),%eax
801048d9:	50                   	push   %eax
801048da:	6a 00                	push   $0x0
801048dc:	e8 8f 08 00 00       	call   80105170 <argint>
801048e1:	83 c4 10             	add    $0x10,%esp
801048e4:	85 c0                	test   %eax,%eax
801048e6:	78 78                	js     80104960 <exec_time_helper+0x90>
801048e8:	83 ec 08             	sub    $0x8,%esp
801048eb:	8d 45 f4             	lea    -0xc(%ebp),%eax
801048ee:	50                   	push   %eax
801048ef:	6a 01                	push   $0x1
801048f1:	e8 7a 08 00 00       	call   80105170 <argint>
801048f6:	83 c4 10             	add    $0x10,%esp
801048f9:	85 c0                	test   %eax,%eax
801048fb:	78 63                	js     80104960 <exec_time_helper+0x90>
    return -22;
  }
  struct proc *p;
  int f = 0;
...
80104900:	68 20 2d 11 80       	push   $0x80112d20
80104905:	e8 e6 04 00 00       	call   80104df0 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == pid){
8010490a:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010490d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104910:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104915:	eb 15                	jmp    8010492c <exec_time_helper+0x5c>
80104917:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010491e:	66 90                	xchg   %ax,%ax
80104920:	05 98 00 00 00       	add    $0x98,%eax
80104925:	3d 54 53 11 80       	cmp    $0x80115354,%eax
8010492a:	74 24                	je     80104950 <exec_time_helper+0x80>
    if(p->pid == pid){
8010492c:	39 50 10             	cmp    %edx,0x10(%eax)
8010492f:	75 ef                	jne    80104920 <exec_time_helper+0x50>
      f = 1;
      p->exec_time = etime;
...
80104934:	83 ec 0c             	sub    $0xc,%esp
      p->exec_time = etime;
80104937:	89 90 84 00 00 00    	mov    %edx,0x84(%eax)
  release(&ptable.lock);
8010493d:	68 20 2d 11 80       	push   $0x80112d20
80104942:	e8 49 04 00 00       	call   80104d90 <release>
...
80104953:	68 20 2d 11 80       	push   $0x80112d20
80104958:	e8 33 04 00 00       	call   80104d90 <release>
    return -22;
8010495d:	83 c4 10             	add    $0x10,%esp
}
80104960:	c9                   	leave  
    return -22;
80104961:	b8 ea ff ff ff       	mov    $0xffffffea,%eax
}
80104966:	c3                   	ret    
80104967:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010496e:	66 90                	xchg   %ax,%ax

80104970 <deadline_helper>:

int
deadline_helper(void)
{
...
8010497c:	e8 ef 07 00 00       	call   80105170 <argint>
80104981:	83 c4 10             	add    $0x10,%esp
80104984:	85 c0                	test   %eax,%eax
80104986:	78 78                	js     80104a00 <deadline_helper+0x90>
80104988:	83 ec 08             	sub    $0x8,%esp
8010498b:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010498e:	50                   	push   %eax
8010498f:	6a 01                	push   $0x1
80104991:	e8 da 07 00 00       	call   80105170 <argint>
80104996:	83 c4 10             	add    $0x10,%esp
80104999:	85 c0                	test   %eax,%eax
8010499b:	78 63                	js     80104a00 <deadline_helper+0x90>
    return -22;
  }
  struct proc *p;
  int f = 0;
...
801049a0:	68 20 2d 11 80       	push   $0x80112d20
801049a5:	e8 46 04 00 00       	call   80104df0 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == pid){
801049aa:	8b 55 f0             	mov    -0x10(%ebp),%edx
801049ad:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049b0:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801049b5:	eb 15                	jmp    801049cc <deadline_helper+0x5c>
801049b7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801049be:	66 90                	xchg   %ax,%ax
801049c0:	05 98 00 00 00       	add    $0x98,%eax
801049c5:	3d 54 53 11 80       	cmp    $0x80115354,%eax
801049ca:	74 24                	je     801049f0 <deadline_helper+0x80>
    if(p->pid == pid){
801049cc:	39 50 10             	cmp    %edx,0x10(%eax)
801049cf:	75 ef                	jne    801049c0 <deadline_helper+0x50>
      f = 1;
      p->deadline = deadline;
801049d1:	8b 55 f4             	mov    -0xc(%ebp),%edx
      break;
    }
  }
  release(&ptable.lock);
801049d4:	83 ec 0c             	sub    $0xc,%esp
      p->deadline = deadline;
801049d7:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
  release(&ptable.lock);
801049dd:	68 20 2d 11 80       	push   $0x80112d20
801049e2:	e8 a9 03 00 00       	call   80104d90 <release>
...
801049f3:	68 20 2d 11 80       	push   $0x80112d20
801049f8:	e8 93 03 00 00       	call   80104d90 <release>
    return -22;
801049fd:	83 c4 10             	add    $0x10,%esp
}
80104a00:	c9                   	leave  
    return -22;
80104a01:	b8 ea ff ff ff       	mov    $0xffffffea,%eax
}
80104a06:	c3                   	ret    
80104a07:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104a0e:	66 90                	xchg   %ax,%ax

80104a10 <rate_helper>:
...
80104a49:	68 20 2d 11 80       	push   $0x80112d20
80104a4e:	e8 9d 03 00 00       	call   80104df0 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == pid){
80104a53:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104a56:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a59:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
80104a5e:	eb 0e                	jmp    80104a6e <rate_helper+0x5e>
80104a60:	81 c1 98 00 00 00    	add    $0x98,%ecx
80104a66:	81 f9 54 53 11 80    	cmp    $0x80115354,%ecx
80104a6c:	74 62                	je     80104ad0 <rate_helper+0xc0>
    if(p->pid == pid){
80104a6e:	39 41 10             	cmp    %eax,0x10(%ecx)
80104a71:	75 ed                	jne    80104a60 <rate_helper+0x50>
      f = 1;
      p->rate = rate;
80104a73:	8b 55 f4             	mov    -0xc(%ebp),%edx
      int prio;
      if(((30 - rate)*3) % 29 == 0){
80104a76:	b8 1e 00 00 00       	mov    $0x1e,%eax
80104a7b:	29 d0                	sub    %edx,%eax
      p->rate = rate;
80104a7d:	89 91 90 00 00 00    	mov    %edx,0x90(%ecx)
        prio = ((30-rate) * 3)/29;
80104a83:	ba 09 cb 3d 8d       	mov    $0x8d3dcb09,%edx
      if(((30 - rate)*3) % 29 == 0){
80104a88:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
        prio = ((30-rate) * 3)/29;
80104a8b:	89 d8                	mov    %ebx,%eax
80104a8d:	f7 ea                	imul   %edx
80104a8f:	89 d8                	mov    %ebx,%eax
80104a91:	c1 f8 1f             	sar    $0x1f,%eax
80104a94:	01 da                	add    %ebx,%edx
80104a96:	c1 fa 04             	sar    $0x4,%edx
80104a99:	29 c2                	sub    %eax,%edx
      if(((30 - rate)*3) % 29 == 0){
80104a9b:	6b c2 1d             	imul   $0x1d,%edx,%eax
80104a9e:	29 c3                	sub    %eax,%ebx
      }
      else{
        prio = (((30-rate) * 3)/29) + 1;
      }
      p->weight = MAXEL(1,prio);
80104aa0:	b8 01 00 00 00       	mov    $0x1,%eax
        prio = (((30-rate) * 3)/29) + 1;
80104aa5:	83 fb 01             	cmp    $0x1,%ebx
80104aa8:	83 da ff             	sbb    $0xffffffff,%edx
      p->weight = MAXEL(1,prio);
80104aab:	85 d2                	test   %edx,%edx
80104aad:	0f 4e d0             	cmovle %eax,%edx
      break;
    }
  }
  release(&ptable.lock);
80104ab0:	83 ec 0c             	sub    $0xc,%esp
      p->weight = MAXEL(1,prio);
80104ab3:	89 91 80 00 00 00    	mov    %edx,0x80(%ecx)
  release(&ptable.lock);
80104ab9:	68 20 2d 11 80       	push   $0x80112d20
80104abe:	e8 cd 02 00 00       	call   80104d90 <release>
...
80104ac3:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  release(&ptable.lock);
...
80104ad3:	68 20 2d 11 80       	push   $0x80112d20
80104ad8:	e8 b3 02 00 00       	call   80104d90 <release>
    return -22;
80104add:	83 c4 10             	add    $0x10,%esp
}
80104ae0:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    return -22;
80104ae3:	b8 ea ff ff ff       	mov    $0xffffffea,%eax
}
80104ae8:	c9                   	leave  
80104ae9:	c3                   	ret    
...
80104afa:	68 e4 80 10 80       	push   $0x801080e4
...
80104b55:	e8 d6 f6 ff ff       	call   80104230 <sleep>
  while (lk->locked) {
...
80104b63:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104b69:	e8 e2 ee ff ff       	call   80103a50 <myproc>
...
80104bb4:	e8 37 f7 ff ff       	call   801042f0 <wakeup>
  release(&lk->lk);
...
80104c0b:	e8 40 ee ff ff       	call   80103a50 <myproc>
...
80104cca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80104cd0:	e8 fb ec ff ff       	call   801039d0 <mycpu>
...
80104d1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104d20:	e8 ab ec ff ff       	call   801039d0 <mycpu>
...
80104d35:	68 ef 80 10 80       	push   $0x801080ef
80104d3a:	e8 41 b6 ff ff       	call   80100380 <panic>
    panic("popcli");
80104d3f:	83 ec 0c             	sub    $0xc,%esp
80104d42:	68 06 81 10 80       	push   $0x80108106
...
80104d73:	e8 58 ec ff ff       	call   801039d0 <mycpu>
...
80104e2c:	e8 9f eb ff ff       	call   801039d0 <mycpu>
...
80104e8b:	e8 40 eb ff ff       	call   801039d0 <mycpu>
...
80104ea0:	68 15 81 10 80       	push   $0x80108115
...
801050e7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801050ea:	e8 61 e9 ff ff       	call   80103a50 <myproc>
...
80105127:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010512a:	e8 21 e9 ff ff       	call   80103a50 <myproc>
...
80105175:	e8 d6 e8 ff ff       	call   80103a50 <myproc>
...
80105183:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80105186:	e8 c5 e8 ff ff       	call   80103a50 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
801051c6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
801051c9:	e8 82 e8 ff ff       	call   80103a50 <myproc>
801051ce:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801051d0:	e8 7b e8 ff ff       	call   80103a50 <myproc>
...
801051de:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801051e1:	e8 6a e8 ff ff       	call   80103a50 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80105234:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80105235:	e8 16 e8 ff ff       	call   80103a50 <myproc>
...
80105243:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80105246:	e8 05 e8 ff ff       	call   80103a50 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
8010525b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
8010525e:	e8 ed e7 ff ff       	call   80103a50 <myproc>
  if(addr >= curproc->sz)
...
801052b4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801052b7:	e8 94 e7 ff ff       	call   80103a50 <myproc>
...
801052c7:	83 fa 18             	cmp    $0x18,%edx
801052ca:	77 24                	ja     801052f0 <syscall+0x40>
801052cc:	8b 14 85 40 81 10 80 	mov    -0x7fef7ec0(,%eax,4),%edx
...
801052f8:	68 1d 81 10 80       	push   $0x8010811d
...
80105454:	68 c4 81 10 80       	push   $0x801081c4
...
8010546c:	68 c3 81 10 80       	push   $0x801081c3
...
80105481:	68 b7 81 10 80       	push   $0x801081b7
...
8010549f:	68 c6 81 10 80       	push   $0x801081c6
801054a4:	e8 d7 ae ff ff       	call   80100380 <panic>
    panic("create: ialloc");
801054a9:	83 ec 0c             	sub    $0xc,%esp
801054ac:	68 a8 81 10 80       	push   $0x801081a8
...
801054e0:	e8 6b e5 ff ff       	call   80103a50 <myproc>
...
801054ee:	74 20                	je     80105510 <sys_dup+0x50>
  struct proc *curproc = myproc();
801054f0:	e8 5b e5 ff ff       	call   80103a50 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105560:	e8 eb e4 ff ff       	call   80103a50 <myproc>
...
801055e0:	e8 6b e4 ff ff       	call   80103a50 <myproc>
...
80105671:	74 25                	je     80105698 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80105673:	e8 d8 e3 ff ff       	call   80103a50 <myproc>
  fileclose(f);
...
801056c0:	e8 8b e3 ff ff       	call   80103a50 <myproc>
...
801058ad:	58                   	pop    %eax
801058ae:	5a                   	pop    %edx
801058af:	68 c4 81 10 80       	push   $0x801081c4
...
801058c8:	68 c3 81 10 80       	push   $0x801081c3
...
80105ab7:	74 23                	je     80105adc <sys_open+0x9c>
  struct proc *curproc = myproc();
80105ab9:	e8 92 df ff ff       	call   80103a50 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105c75:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105c78:	e8 d3 dd ff ff       	call   80103a50 <myproc>
...
80105e87:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105e8a:	e8 c1 db ff ff       	call   80103a50 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105ea6:	75 f0                	jne    80105e98 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105ea8:	e8 a3 db ff ff       	call   80103a50 <myproc>
...
{
  return fork();
80105ee0:	e9 4b dd ff ff       	jmp    80103c30 <fork>
...
80105ef3:	83 ec 08             	sub    $0x8,%esp
  exit();
80105ef6:	e8 85 e0 ff ff       	call   80103f80 <exit>
...
{
  return wait();
80105f00:	e9 ab e1 ff ff       	jmp    801040b0 <wait>
...
80105f2e:	e8 1d e4 ff ff       	call   80104350 <kill>
...
80105f53:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105f56:	e8 f5 da ff ff       	call   80103a50 <myproc>
...
80105f77:	78 27                	js     80105fa0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105f79:	e8 d2 da ff ff       	call   80103a50 <myproc>
  if(growproc(n) < 0)
...
80105f86:	e8 25 dc ff ff       	call   80103bb0 <growproc>
...
80105fd0:	68 80 53 11 80       	push   $0x80115380
80105fd5:	e8 16 ee ff ff       	call   80104df0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105fda:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105fdd:	8b 1d 60 53 11 80    	mov    0x80115360,%ebx
  while(ticks - ticks0 < n){
...
80105ff3:	68 80 53 11 80       	push   $0x80115380
80105ff8:	68 60 53 11 80       	push   $0x80115360
80105ffd:	e8 2e e2 ff ff       	call   80104230 <sleep>
  while(ticks - ticks0 < n){
80106002:	a1 60 53 11 80       	mov    0x80115360,%eax
...
8010600f:	73 2f                	jae    80106040 <sys_sleep+0x90>
    if(myproc()->killed){
80106011:	e8 3a da ff ff       	call   80103a50 <myproc>
...
80106020:	68 80 53 11 80       	push   $0x80115380
...
80106043:	68 80 53 11 80       	push   $0x80115380
...
80106064:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80106067:	68 80 53 11 80       	push   $0x80115380
8010606c:	e8 7f ed ff ff       	call   80104df0 <acquire>
  xticks = ticks;
80106071:	8b 1d 60 53 11 80    	mov    0x80115360,%ebx
  release(&tickslock);
80106077:	c7 04 24 80 53 11 80 	movl   $0x80115380,(%esp)
...
80106090:	e9 4b e7 ff ff       	jmp    801047e0 <sched_policy_helper>
80106095:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010609c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

801060a0 <sys_exec_time>:
}

int sys_exec_time(void)
{
  return exec_time_helper();
801060a0:	e9 2b e8 ff ff       	jmp    801048d0 <exec_time_helper>
801060a5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801060ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

801060b0 <sys_deadline>:
}

int sys_deadline(void)
{
  return deadline_helper();
801060b0:	e9 bb e8 ff ff       	jmp    80104970 <deadline_helper>
...
{
  return rate_helper();
801060c0:	e9 4b e9 ff ff       	jmp    80104a10 <rate_helper>
...
801060c6:	06                   	push   %es
  pushl %fs
801060c7:	0f a0                	push   %fs
  pushl %gs
801060c9:	0f a8                	push   %gs
  pushal
801060cb:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801060cc:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801060d0:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801060d2:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801060d4:	54                   	push   %esp
  call trap
801060d5:	e8 c6 00 00 00       	call   801061a0 <trap>
  addl $4, %esp
801060da:	83 c4 04             	add    $0x4,%esp
...
801060dd:	61                   	popa   
  popl %gs
801060de:	0f a9                	pop    %gs
  popl %fs
801060e0:	0f a1                	pop    %fs
  popl %es
801060e2:	07                   	pop    %es
  popl %ds
801060e3:	1f                   	pop    %ds
...
80106107:	c7 04 c5 c2 53 11 80 	movl   $0x8e000008,-0x7feeac3e(,%eax,8)
8010610e:	08 00 00 8e 
80106112:	66 89 14 c5 c0 53 11 	mov    %dx,-0x7feeac40(,%eax,8)
80106119:	80 
8010611a:	c1 ea 10             	shr    $0x10,%edx
8010611d:	66 89 14 c5 c6 53 11 	mov    %dx,-0x7feeac3a(,%eax,8)
80106124:	80 
  for(i = 0; i < 256; i++)
...
80106137:	c7 05 c2 55 11 80 08 	movl   $0xef000008,0x801155c2
8010613e:	00 00 ef 
  initlock(&tickslock, "time");
80106141:	68 09 82 10 80       	push   $0x80108209
80106146:	68 80 53 11 80       	push   $0x80115380
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010614b:	66 a3 c0 55 11 80    	mov    %ax,0x801155c0
80106151:	c1 e8 10             	shr    $0x10,%eax
80106154:	66 a3 c6 55 11 80    	mov    %ax,0x801155c6
  initlock(&tickslock, "time");
8010615a:	e8 c1 ea ff ff       	call   80104c20 <initlock>
}
...
8010617b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010617f:	b8 c0 53 11 80       	mov    $0x801153c0,%eax
...
801061b2:	0f 84 90 01 00 00    	je     80106348 <trap+0x1a8>
    if(myproc()->killed)
      exit();
    return;
  }
...
801061c4:	ff 24 85 d4 82 10 80 	jmp    *-0x7fef7d2c(,%eax,4)
...
801061cf:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801061d0:	e8 6b c0 ff ff       	call   80102240 <ideintr>
    lapiceoi();
...
801061da:	e8 71 d8 ff ff       	call   80103a50 <myproc>
801061df:	85 c0                	test   %eax,%eax
801061e1:	74 1d                	je     80106200 <trap+0x60>
801061e3:	e8 68 d8 ff ff       	call   80103a50 <myproc>
801061e8:	8b 48 24             	mov    0x24(%eax),%ecx
801061eb:	85 c9                	test   %ecx,%ecx
801061ed:	74 11                	je     80106200 <trap+0x60>
801061ef:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801061f3:	83 e0 03             	and    $0x3,%eax
801061f6:	66 83 f8 03          	cmp    $0x3,%ax
801061fa:	0f 84 10 02 00 00    	je     80106410 <trap+0x270>
...
80106200:	e8 4b d8 ff ff       	call   80103a50 <myproc>
80106205:	85 c0                	test   %eax,%eax
80106207:	74 0f                	je     80106218 <trap+0x78>
80106209:	e8 42 d8 ff ff       	call   80103a50 <myproc>
8010620e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80106212:	0f 84 b8 00 00 00    	je     801062d0 <trap+0x130>
      yield();
    }
  }
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106218:	e8 33 d8 ff ff       	call   80103a50 <myproc>
8010621d:	85 c0                	test   %eax,%eax
8010621f:	74 1d                	je     8010623e <trap+0x9e>
80106221:	e8 2a d8 ff ff       	call   80103a50 <myproc>
80106226:	8b 40 24             	mov    0x24(%eax),%eax
80106229:	85 c0                	test   %eax,%eax
8010622b:	74 11                	je     8010623e <trap+0x9e>
8010622d:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80106231:	83 e0 03             	and    $0x3,%eax
80106234:	66 83 f8 03          	cmp    $0x3,%ax
80106238:	0f 84 37 01 00 00    	je     80106375 <trap+0x1d5>
    exit();
}
...
80106250:	e8 fb d7 ff ff       	call   80103a50 <myproc>
80106255:	8b 7b 38             	mov    0x38(%ebx),%edi
80106258:	85 c0                	test   %eax,%eax
8010625a:	0f 84 ec 01 00 00    	je     8010644c <trap+0x2ac>
80106260:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80106264:	0f 84 e2 01 00 00    	je     8010644c <trap+0x2ac>
...
80106270:	e8 bb d7 ff ff       	call   80103a30 <cpuid>
...
80106281:	e8 ca d7 ff ff       	call   80103a50 <myproc>
80106286:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106289:	e8 c2 d7 ff ff       	call   80103a50 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
8010629e:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801062a1:	56                   	push   %esi
801062a2:	ff 70 10             	push   0x10(%eax)
801062a5:	68 6c 82 10 80       	push   $0x8010826c
801062aa:	e8 f1 a3 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
801062af:	83 c4 20             	add    $0x20,%esp
801062b2:	e8 99 d7 ff ff       	call   80103a50 <myproc>
801062b7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801062be:	e8 8d d7 ff ff       	call   80103a50 <myproc>
801062c3:	85 c0                	test   %eax,%eax
801062c5:	0f 85 18 ff ff ff    	jne    801061e3 <trap+0x43>
801062cb:	e9 30 ff ff ff       	jmp    80106200 <trap+0x60>
  if(myproc() && myproc()->state == RUNNING &&
801062d0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
801062d4:	0f 85 3e ff ff ff    	jne    80106218 <trap+0x78>
    if((myproc()->sched_policy >= 0) &&
801062da:	e8 71 d7 ff ff       	call   80103a50 <myproc>
801062df:	8b 90 94 00 00 00    	mov    0x94(%eax),%edx
801062e5:	85 d2                	test   %edx,%edx
801062e7:	78 1c                	js     80106305 <trap+0x165>
      (myproc()->elapsed_time >= myproc()->exec_time))
801062e9:	e8 62 d7 ff ff       	call   80103a50 <myproc>
801062ee:	8b b0 88 00 00 00    	mov    0x88(%eax),%esi
801062f4:	e8 57 d7 ff ff       	call   80103a50 <myproc>
    if((myproc()->sched_policy >= 0) &&
801062f9:	3b b0 84 00 00 00    	cmp    0x84(%eax),%esi
801062ff:	0f 8d 25 01 00 00    	jge    8010642a <trap+0x28a>
      yield();
80106305:	e8 d6 de ff ff       	call   801041e0 <yield>
8010630a:	e9 09 ff ff ff       	jmp    80106218 <trap+0x78>
8010630f:	90                   	nop
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106310:	8b 7b 38             	mov    0x38(%ebx),%edi
80106313:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80106317:	e8 14 d7 ff ff       	call   80103a30 <cpuid>
8010631c:	57                   	push   %edi
8010631d:	56                   	push   %esi
8010631e:	50                   	push   %eax
8010631f:	68 14 82 10 80       	push   $0x80108214
80106324:	e8 77 a3 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80106329:	e8 e2 c5 ff ff       	call   80102910 <lapiceoi>
    break;
8010632e:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106331:	e8 1a d7 ff ff       	call   80103a50 <myproc>
80106336:	85 c0                	test   %eax,%eax
80106338:	0f 85 a5 fe ff ff    	jne    801061e3 <trap+0x43>
8010633e:	e9 bd fe ff ff       	jmp    80106200 <trap+0x60>
80106343:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106347:	90                   	nop
    if(myproc()->killed)
80106348:	e8 03 d7 ff ff       	call   80103a50 <myproc>
8010634d:	8b 70 24             	mov    0x24(%eax),%esi
80106350:	85 f6                	test   %esi,%esi
80106352:	0f 85 c8 00 00 00    	jne    80106420 <trap+0x280>
    myproc()->tf = tf;
80106358:	e8 f3 d6 ff ff       	call   80103a50 <myproc>
8010635d:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80106360:	e8 4b ef ff ff       	call   801052b0 <syscall>
    if(myproc()->killed)
80106365:	e8 e6 d6 ff ff       	call   80103a50 <myproc>
8010636a:	8b 58 24             	mov    0x24(%eax),%ebx
8010636d:	85 db                	test   %ebx,%ebx
8010636f:	0f 84 c9 fe ff ff    	je     8010623e <trap+0x9e>
}
...
8010637b:	5d                   	pop    %ebp
      exit();
8010637c:	e9 ff db ff ff       	jmp    80103f80 <exit>
80106381:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80106388:	e8 63 02 00 00       	call   801065f0 <uartintr>
    lapiceoi();
8010638d:	e8 7e c5 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106392:	e8 b9 d6 ff ff       	call   80103a50 <myproc>
80106397:	85 c0                	test   %eax,%eax
80106399:	0f 85 44 fe ff ff    	jne    801061e3 <trap+0x43>
8010639f:	e9 5c fe ff ff       	jmp    80106200 <trap+0x60>
801063a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801063a8:	e8 23 c4 ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
801063ad:	e8 5e c5 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801063b2:	e8 99 d6 ff ff       	call   80103a50 <myproc>
801063b7:	85 c0                	test   %eax,%eax
801063b9:	0f 85 24 fe ff ff    	jne    801061e3 <trap+0x43>
801063bf:	e9 3c fe ff ff       	jmp    80106200 <trap+0x60>
801063c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
801063c8:	e8 63 d6 ff ff       	call   80103a30 <cpuid>
801063cd:	85 c0                	test   %eax,%eax
801063cf:	0f 85 00 fe ff ff    	jne    801061d5 <trap+0x35>
      acquire(&tickslock);
801063d5:	83 ec 0c             	sub    $0xc,%esp
801063d8:	68 80 53 11 80       	push   $0x80115380
801063dd:	e8 0e ea ff ff       	call   80104df0 <acquire>
      ticks++;
801063e2:	83 05 60 53 11 80 01 	addl   $0x1,0x80115360
      update_proc_stats(); //will update process statistics on every clock tick
801063e9:	e8 a2 e0 ff ff       	call   80104490 <update_proc_stats>
      wakeup(&ticks);
801063ee:	c7 04 24 60 53 11 80 	movl   $0x80115360,(%esp)
801063f5:	e8 f6 de ff ff       	call   801042f0 <wakeup>
      release(&tickslock);
801063fa:	c7 04 24 80 53 11 80 	movl   $0x80115380,(%esp)
80106401:	e8 8a e9 ff ff       	call   80104d90 <release>
80106406:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80106409:	e9 c7 fd ff ff       	jmp    801061d5 <trap+0x35>
8010640e:	66 90                	xchg   %ax,%ax
    exit();
80106410:	e8 6b db ff ff       	call   80103f80 <exit>
80106415:	e9 e6 fd ff ff       	jmp    80106200 <trap+0x60>
8010641a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80106420:	e8 5b db ff ff       	call   80103f80 <exit>
80106425:	e9 2e ff ff ff       	jmp    80106358 <trap+0x1b8>
      myproc()->pid);
8010642a:	e8 21 d6 ff ff       	call   80103a50 <myproc>
      cprintf("The completed process has pid: %d\n",
8010642f:	83 ec 08             	sub    $0x8,%esp
80106432:	ff 70 10             	push   0x10(%eax)
80106435:	68 b0 82 10 80       	push   $0x801082b0
8010643a:	e8 61 a2 ff ff       	call   801006a0 <cprintf>
      exit();
8010643f:	e8 3c db ff ff       	call   80103f80 <exit>
80106444:	83 c4 10             	add    $0x10,%esp
80106447:	e9 cc fd ff ff       	jmp    80106218 <trap+0x78>
8010644c:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010644f:	e8 dc d5 ff ff       	call   80103a30 <cpuid>
80106454:	83 ec 0c             	sub    $0xc,%esp
80106457:	56                   	push   %esi
80106458:	57                   	push   %edi
80106459:	50                   	push   %eax
8010645a:	ff 73 30             	push   0x30(%ebx)
8010645d:	68 38 82 10 80       	push   $0x80108238
80106462:	e8 39 a2 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80106467:	83 c4 14             	add    $0x14,%esp
8010646a:	68 0e 82 10 80       	push   $0x8010820e
8010646f:	e8 0c 9f ff ff       	call   80100380 <panic>
80106474:	66 90                	xchg   %ax,%ax
...
{
  if(!uart)
80106480:	a1 c0 5b 11 80       	mov    0x80115bc0,%eax
...
80106507:	74 78                	je     80106581 <uartinit+0xd1>
  uart = 1;
80106509:	c7 05 c0 5b 11 80 01 	movl   $0x1,0x80115bc0
80106510:	00 00 00 
...
8010651c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
8010651f:	bf 54 83 10 80       	mov    $0x80108354,%edi
80106524:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80106529:	6a 00                	push   $0x0
8010652b:	6a 04                	push   $0x4
8010652d:	e8 4e bf ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80106532:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
80106536:	83 c4 10             	add    $0x10,%esp
80106539:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80106540:	a1 c0 5b 11 80       	mov    0x80115bc0,%eax
...
80106555:	e8 d6 c3 ff ff       	call   80102930 <microdelay>
...
80106590 <uartputc>:
  if(!uart)
80106590:	a1 c0 5b 11 80       	mov    0x80115bc0,%eax
...
801065b5:	e8 76 c3 ff ff       	call   80102930 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
...
801065fb:	e8 80 a2 ff ff       	call   80100880 <consoleintr>
}
...
80106607:	6a 00                	push   $0x0
  jmp alltraps
80106609:	e9 b7 fa ff ff       	jmp    801060c5 <alltraps>
...
80106610:	6a 01                	push   $0x1
  jmp alltraps
80106612:	e9 ae fa ff ff       	jmp    801060c5 <alltraps>
...
80106619:	6a 02                	push   $0x2
  jmp alltraps
8010661b:	e9 a5 fa ff ff       	jmp    801060c5 <alltraps>
...
80106622:	6a 03                	push   $0x3
  jmp alltraps
80106624:	e9 9c fa ff ff       	jmp    801060c5 <alltraps>
...
8010662b:	6a 04                	push   $0x4
  jmp alltraps
8010662d:	e9 93 fa ff ff       	jmp    801060c5 <alltraps>
...
80106634:	6a 05                	push   $0x5
  jmp alltraps
80106636:	e9 8a fa ff ff       	jmp    801060c5 <alltraps>
...
8010663d:	6a 06                	push   $0x6
  jmp alltraps
8010663f:	e9 81 fa ff ff       	jmp    801060c5 <alltraps>
...
80106646:	6a 07                	push   $0x7
  jmp alltraps
80106648:	e9 78 fa ff ff       	jmp    801060c5 <alltraps>
...
8010664d:	6a 08                	push   $0x8
  jmp alltraps
8010664f:	e9 71 fa ff ff       	jmp    801060c5 <alltraps>
...
80106656:	6a 09                	push   $0x9
  jmp alltraps
80106658:	e9 68 fa ff ff       	jmp    801060c5 <alltraps>
...
8010665d:	6a 0a                	push   $0xa
  jmp alltraps
8010665f:	e9 61 fa ff ff       	jmp    801060c5 <alltraps>
...
80106664:	6a 0b                	push   $0xb
  jmp alltraps
80106666:	e9 5a fa ff ff       	jmp    801060c5 <alltraps>
...
8010666b:	6a 0c                	push   $0xc
  jmp alltraps
8010666d:	e9 53 fa ff ff       	jmp    801060c5 <alltraps>
...
80106672:	6a 0d                	push   $0xd
  jmp alltraps
80106674:	e9 4c fa ff ff       	jmp    801060c5 <alltraps>
...
80106679:	6a 0e                	push   $0xe
  jmp alltraps
8010667b:	e9 45 fa ff ff       	jmp    801060c5 <alltraps>
...
80106682:	6a 0f                	push   $0xf
  jmp alltraps
80106684:	e9 3c fa ff ff       	jmp    801060c5 <alltraps>
...
8010668b:	6a 10                	push   $0x10
  jmp alltraps
8010668d:	e9 33 fa ff ff       	jmp    801060c5 <alltraps>
...
80106692:	6a 11                	push   $0x11
  jmp alltraps
80106694:	e9 2c fa ff ff       	jmp    801060c5 <alltraps>
...
8010669b:	6a 12                	push   $0x12
  jmp alltraps
8010669d:	e9 23 fa ff ff       	jmp    801060c5 <alltraps>
...
801066a4:	6a 13                	push   $0x13
  jmp alltraps
801066a6:	e9 1a fa ff ff       	jmp    801060c5 <alltraps>
...
801066ad:	6a 14                	push   $0x14
  jmp alltraps
801066af:	e9 11 fa ff ff       	jmp    801060c5 <alltraps>
...
801066b6:	6a 15                	push   $0x15
  jmp alltraps
801066b8:	e9 08 fa ff ff       	jmp    801060c5 <alltraps>
...
801066bf:	6a 16                	push   $0x16
  jmp alltraps
801066c1:	e9 ff f9 ff ff       	jmp    801060c5 <alltraps>
...
801066c8:	6a 17                	push   $0x17
  jmp alltraps
801066ca:	e9 f6 f9 ff ff       	jmp    801060c5 <alltraps>
...
801066d1:	6a 18                	push   $0x18
  jmp alltraps
801066d3:	e9 ed f9 ff ff       	jmp    801060c5 <alltraps>
...
801066da:	6a 19                	push   $0x19
  jmp alltraps
801066dc:	e9 e4 f9 ff ff       	jmp    801060c5 <alltraps>
...
801066e3:	6a 1a                	push   $0x1a
  jmp alltraps
801066e5:	e9 db f9 ff ff       	jmp    801060c5 <alltraps>
...
801066ec:	6a 1b                	push   $0x1b
  jmp alltraps
801066ee:	e9 d2 f9 ff ff       	jmp    801060c5 <alltraps>
...
801066f5:	6a 1c                	push   $0x1c
  jmp alltraps
801066f7:	e9 c9 f9 ff ff       	jmp    801060c5 <alltraps>
...
801066fe:	6a 1d                	push   $0x1d
  jmp alltraps
80106700:	e9 c0 f9 ff ff       	jmp    801060c5 <alltraps>
...
80106707:	6a 1e                	push   $0x1e
  jmp alltraps
80106709:	e9 b7 f9 ff ff       	jmp    801060c5 <alltraps>
...
80106710:	6a 1f                	push   $0x1f
  jmp alltraps
80106712:	e9 ae f9 ff ff       	jmp    801060c5 <alltraps>
...
80106719:	6a 20                	push   $0x20
  jmp alltraps
8010671b:	e9 a5 f9 ff ff       	jmp    801060c5 <alltraps>
...
80106722:	6a 21                	push   $0x21
  jmp alltraps
80106724:	e9 9c f9 ff ff       	jmp    801060c5 <alltraps>
...
8010672b:	6a 22                	push   $0x22
  jmp alltraps
8010672d:	e9 93 f9 ff ff       	jmp    801060c5 <alltraps>
...
80106734:	6a 23                	push   $0x23
  jmp alltraps
80106736:	e9 8a f9 ff ff       	jmp    801060c5 <alltraps>
...
8010673d:	6a 24                	push   $0x24
  jmp alltraps
8010673f:	e9 81 f9 ff ff       	jmp    801060c5 <alltraps>
...
80106746:	6a 25                	push   $0x25
  jmp alltraps
80106748:	e9 78 f9 ff ff       	jmp    801060c5 <alltraps>
...
8010674f:	6a 26                	push   $0x26
  jmp alltraps
80106751:	e9 6f f9 ff ff       	jmp    801060c5 <alltraps>
...
80106758:	6a 27                	push   $0x27
  jmp alltraps
8010675a:	e9 66 f9 ff ff       	jmp    801060c5 <alltraps>
...
80106761:	6a 28                	push   $0x28
  jmp alltraps
80106763:	e9 5d f9 ff ff       	jmp    801060c5 <alltraps>
...
8010676a:	6a 29                	push   $0x29
  jmp alltraps
8010676c:	e9 54 f9 ff ff       	jmp    801060c5 <alltraps>
...
80106773:	6a 2a                	push   $0x2a
  jmp alltraps
80106775:	e9 4b f9 ff ff       	jmp    801060c5 <alltraps>
...
8010677c:	6a 2b                	push   $0x2b
  jmp alltraps
8010677e:	e9 42 f9 ff ff       	jmp    801060c5 <alltraps>
...
80106785:	6a 2c                	push   $0x2c
  jmp alltraps
80106787:	e9 39 f9 ff ff       	jmp    801060c5 <alltraps>
...
8010678e:	6a 2d                	push   $0x2d
  jmp alltraps
80106790:	e9 30 f9 ff ff       	jmp    801060c5 <alltraps>
...
80106797:	6a 2e                	push   $0x2e
  jmp alltraps
80106799:	e9 27 f9 ff ff       	jmp    801060c5 <alltraps>
...
801067a0:	6a 2f                	push   $0x2f
  jmp alltraps
801067a2:	e9 1e f9 ff ff       	jmp    801060c5 <alltraps>
...
801067a9:	6a 30                	push   $0x30
  jmp alltraps
801067ab:	e9 15 f9 ff ff       	jmp    801060c5 <alltraps>
...
801067b2:	6a 31                	push   $0x31
  jmp alltraps
801067b4:	e9 0c f9 ff ff       	jmp    801060c5 <alltraps>
...
801067bb:	6a 32                	push   $0x32
  jmp alltraps
801067bd:	e9 03 f9 ff ff       	jmp    801060c5 <alltraps>
...
801067c4:	6a 33                	push   $0x33
  jmp alltraps
801067c6:	e9 fa f8 ff ff       	jmp    801060c5 <alltraps>
...
801067cd:	6a 34                	push   $0x34
  jmp alltraps
801067cf:	e9 f1 f8 ff ff       	jmp    801060c5 <alltraps>
...
801067d6:	6a 35                	push   $0x35
  jmp alltraps
801067d8:	e9 e8 f8 ff ff       	jmp    801060c5 <alltraps>
...
801067df:	6a 36                	push   $0x36
  jmp alltraps
801067e1:	e9 df f8 ff ff       	jmp    801060c5 <alltraps>
...
801067e8:	6a 37                	push   $0x37
  jmp alltraps
801067ea:	e9 d6 f8 ff ff       	jmp    801060c5 <alltraps>
...
801067f1:	6a 38                	push   $0x38
  jmp alltraps
801067f3:	e9 cd f8 ff ff       	jmp    801060c5 <alltraps>
...
801067fa:	6a 39                	push   $0x39
  jmp alltraps
801067fc:	e9 c4 f8 ff ff       	jmp    801060c5 <alltraps>
...
80106803:	6a 3a                	push   $0x3a
  jmp alltraps
80106805:	e9 bb f8 ff ff       	jmp    801060c5 <alltraps>
...
8010680c:	6a 3b                	push   $0x3b
  jmp alltraps
8010680e:	e9 b2 f8 ff ff       	jmp    801060c5 <alltraps>
...
80106815:	6a 3c                	push   $0x3c
  jmp alltraps
80106817:	e9 a9 f8 ff ff       	jmp    801060c5 <alltraps>
...
8010681e:	6a 3d                	push   $0x3d
  jmp alltraps
80106820:	e9 a0 f8 ff ff       	jmp    801060c5 <alltraps>
...
80106827:	6a 3e                	push   $0x3e
  jmp alltraps
80106829:	e9 97 f8 ff ff       	jmp    801060c5 <alltraps>
...
80106830:	6a 3f                	push   $0x3f
  jmp alltraps
80106832:	e9 8e f8 ff ff       	jmp    801060c5 <alltraps>
...
80106839:	6a 40                	push   $0x40
  jmp alltraps
8010683b:	e9 85 f8 ff ff       	jmp    801060c5 <alltraps>
...
80106842:	6a 41                	push   $0x41
  jmp alltraps
80106844:	e9 7c f8 ff ff       	jmp    801060c5 <alltraps>
...
8010684b:	6a 42                	push   $0x42
  jmp alltraps
8010684d:	e9 73 f8 ff ff       	jmp    801060c5 <alltraps>
...
80106854:	6a 43                	push   $0x43
  jmp alltraps
80106856:	e9 6a f8 ff ff       	jmp    801060c5 <alltraps>
...
8010685d:	6a 44                	push   $0x44
  jmp alltraps
8010685f:	e9 61 f8 ff ff       	jmp    801060c5 <alltraps>
...
80106866:	6a 45                	push   $0x45
  jmp alltraps
80106868:	e9 58 f8 ff ff       	jmp    801060c5 <alltraps>
...
8010686f:	6a 46                	push   $0x46
  jmp alltraps
80106871:	e9 4f f8 ff ff       	jmp    801060c5 <alltraps>
...
80106878:	6a 47                	push   $0x47
  jmp alltraps
8010687a:	e9 46 f8 ff ff       	jmp    801060c5 <alltraps>
...
80106881:	6a 48                	push   $0x48
  jmp alltraps
80106883:	e9 3d f8 ff ff       	jmp    801060c5 <alltraps>
...
8010688a:	6a 49                	push   $0x49
  jmp alltraps
8010688c:	e9 34 f8 ff ff       	jmp    801060c5 <alltraps>
...
80106893:	6a 4a                	push   $0x4a
  jmp alltraps
80106895:	e9 2b f8 ff ff       	jmp    801060c5 <alltraps>
...
8010689c:	6a 4b                	push   $0x4b
  jmp alltraps
8010689e:	e9 22 f8 ff ff       	jmp    801060c5 <alltraps>
...
801068a5:	6a 4c                	push   $0x4c
  jmp alltraps
801068a7:	e9 19 f8 ff ff       	jmp    801060c5 <alltraps>
...
801068ae:	6a 4d                	push   $0x4d
  jmp alltraps
801068b0:	e9 10 f8 ff ff       	jmp    801060c5 <alltraps>
...
801068b7:	6a 4e                	push   $0x4e
  jmp alltraps
801068b9:	e9 07 f8 ff ff       	jmp    801060c5 <alltraps>
...
801068c0:	6a 4f                	push   $0x4f
  jmp alltraps
801068c2:	e9 fe f7 ff ff       	jmp    801060c5 <alltraps>
...
801068c9:	6a 50                	push   $0x50
  jmp alltraps
801068cb:	e9 f5 f7 ff ff       	jmp    801060c5 <alltraps>
...
801068d2:	6a 51                	push   $0x51
  jmp alltraps
801068d4:	e9 ec f7 ff ff       	jmp    801060c5 <alltraps>
...
801068db:	6a 52                	push   $0x52
  jmp alltraps
801068dd:	e9 e3 f7 ff ff       	jmp    801060c5 <alltraps>
...
801068e4:	6a 53                	push   $0x53
  jmp alltraps
801068e6:	e9 da f7 ff ff       	jmp    801060c5 <alltraps>
...
801068ed:	6a 54                	push   $0x54
  jmp alltraps
801068ef:	e9 d1 f7 ff ff       	jmp    801060c5 <alltraps>
...
801068f6:	6a 55                	push   $0x55
  jmp alltraps
801068f8:	e9 c8 f7 ff ff       	jmp    801060c5 <alltraps>
...
801068ff:	6a 56                	push   $0x56
  jmp alltraps
80106901:	e9 bf f7 ff ff       	jmp    801060c5 <alltraps>
...
80106908:	6a 57                	push   $0x57
  jmp alltraps
8010690a:	e9 b6 f7 ff ff       	jmp    801060c5 <alltraps>
...
80106911:	6a 58                	push   $0x58
  jmp alltraps
80106913:	e9 ad f7 ff ff       	jmp    801060c5 <alltraps>
...
8010691a:	6a 59                	push   $0x59
  jmp alltraps
8010691c:	e9 a4 f7 ff ff       	jmp    801060c5 <alltraps>
...
80106923:	6a 5a                	push   $0x5a
  jmp alltraps
80106925:	e9 9b f7 ff ff       	jmp    801060c5 <alltraps>
...
8010692c:	6a 5b                	push   $0x5b
  jmp alltraps
8010692e:	e9 92 f7 ff ff       	jmp    801060c5 <alltraps>
...
80106935:	6a 5c                	push   $0x5c
  jmp alltraps
80106937:	e9 89 f7 ff ff       	jmp    801060c5 <alltraps>
...
8010693e:	6a 5d                	push   $0x5d
  jmp alltraps
80106940:	e9 80 f7 ff ff       	jmp    801060c5 <alltraps>
...
80106947:	6a 5e                	push   $0x5e
  jmp alltraps
80106949:	e9 77 f7 ff ff       	jmp    801060c5 <alltraps>
...
80106950:	6a 5f                	push   $0x5f
  jmp alltraps
80106952:	e9 6e f7 ff ff       	jmp    801060c5 <alltraps>
...
80106959:	6a 60                	push   $0x60
  jmp alltraps
8010695b:	e9 65 f7 ff ff       	jmp    801060c5 <alltraps>
...
80106962:	6a 61                	push   $0x61
  jmp alltraps
80106964:	e9 5c f7 ff ff       	jmp    801060c5 <alltraps>
...
8010696b:	6a 62                	push   $0x62
  jmp alltraps
8010696d:	e9 53 f7 ff ff       	jmp    801060c5 <alltraps>
...
80106974:	6a 63                	push   $0x63
  jmp alltraps
80106976:	e9 4a f7 ff ff       	jmp    801060c5 <alltraps>
...
8010697d:	6a 64                	push   $0x64
  jmp alltraps
8010697f:	e9 41 f7 ff ff       	jmp    801060c5 <alltraps>
...
80106986:	6a 65                	push   $0x65
  jmp alltraps
80106988:	e9 38 f7 ff ff       	jmp    801060c5 <alltraps>
...
8010698f:	6a 66                	push   $0x66
  jmp alltraps
80106991:	e9 2f f7 ff ff       	jmp    801060c5 <alltraps>
...
80106998:	6a 67                	push   $0x67
  jmp alltraps
8010699a:	e9 26 f7 ff ff       	jmp    801060c5 <alltraps>
...
801069a1:	6a 68                	push   $0x68
  jmp alltraps
801069a3:	e9 1d f7 ff ff       	jmp    801060c5 <alltraps>
...
801069aa:	6a 69                	push   $0x69
  jmp alltraps
801069ac:	e9 14 f7 ff ff       	jmp    801060c5 <alltraps>
...
801069b3:	6a 6a                	push   $0x6a
  jmp alltraps
801069b5:	e9 0b f7 ff ff       	jmp    801060c5 <alltraps>
...
801069bc:	6a 6b                	push   $0x6b
  jmp alltraps
801069be:	e9 02 f7 ff ff       	jmp    801060c5 <alltraps>
...
801069c5:	6a 6c                	push   $0x6c
  jmp alltraps
801069c7:	e9 f9 f6 ff ff       	jmp    801060c5 <alltraps>
...
801069ce:	6a 6d                	push   $0x6d
  jmp alltraps
801069d0:	e9 f0 f6 ff ff       	jmp    801060c5 <alltraps>
...
801069d7:	6a 6e                	push   $0x6e
  jmp alltraps
801069d9:	e9 e7 f6 ff ff       	jmp    801060c5 <alltraps>
...
801069e0:	6a 6f                	push   $0x6f
  jmp alltraps
801069e2:	e9 de f6 ff ff       	jmp    801060c5 <alltraps>
...
801069e9:	6a 70                	push   $0x70
  jmp alltraps
801069eb:	e9 d5 f6 ff ff       	jmp    801060c5 <alltraps>
...
801069f2:	6a 71                	push   $0x71
  jmp alltraps
801069f4:	e9 cc f6 ff ff       	jmp    801060c5 <alltraps>
...
801069fb:	6a 72                	push   $0x72
  jmp alltraps
801069fd:	e9 c3 f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a04:	6a 73                	push   $0x73
  jmp alltraps
80106a06:	e9 ba f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a0d:	6a 74                	push   $0x74
  jmp alltraps
80106a0f:	e9 b1 f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a16:	6a 75                	push   $0x75
  jmp alltraps
80106a18:	e9 a8 f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a1f:	6a 76                	push   $0x76
  jmp alltraps
80106a21:	e9 9f f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a28:	6a 77                	push   $0x77
  jmp alltraps
80106a2a:	e9 96 f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a31:	6a 78                	push   $0x78
  jmp alltraps
80106a33:	e9 8d f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a3a:	6a 79                	push   $0x79
  jmp alltraps
80106a3c:	e9 84 f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a43:	6a 7a                	push   $0x7a
  jmp alltraps
80106a45:	e9 7b f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a4c:	6a 7b                	push   $0x7b
  jmp alltraps
80106a4e:	e9 72 f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a55:	6a 7c                	push   $0x7c
  jmp alltraps
80106a57:	e9 69 f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a5e:	6a 7d                	push   $0x7d
  jmp alltraps
80106a60:	e9 60 f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a67:	6a 7e                	push   $0x7e
  jmp alltraps
80106a69:	e9 57 f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a70:	6a 7f                	push   $0x7f
  jmp alltraps
80106a72:	e9 4e f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a79:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106a7e:	e9 42 f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a85:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106a8a:	e9 36 f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a91:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106a96:	e9 2a f6 ff ff       	jmp    801060c5 <alltraps>
...
80106a9d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106aa2:	e9 1e f6 ff ff       	jmp    801060c5 <alltraps>
...
80106aa9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106aae:	e9 12 f6 ff ff       	jmp    801060c5 <alltraps>
...
80106ab5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106aba:	e9 06 f6 ff ff       	jmp    801060c5 <alltraps>
...
80106ac1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106ac6:	e9 fa f5 ff ff       	jmp    801060c5 <alltraps>
...
80106acd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106ad2:	e9 ee f5 ff ff       	jmp    801060c5 <alltraps>
...
80106ad9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106ade:	e9 e2 f5 ff ff       	jmp    801060c5 <alltraps>
...
80106ae5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106aea:	e9 d6 f5 ff ff       	jmp    801060c5 <alltraps>
...
80106af1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106af6:	e9 ca f5 ff ff       	jmp    801060c5 <alltraps>
...
80106afd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106b02:	e9 be f5 ff ff       	jmp    801060c5 <alltraps>
...
80106b09:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106b0e:	e9 b2 f5 ff ff       	jmp    801060c5 <alltraps>
...
80106b15:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106b1a:	e9 a6 f5 ff ff       	jmp    801060c5 <alltraps>
...
80106b21:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106b26:	e9 9a f5 ff ff       	jmp    801060c5 <alltraps>
...
80106b2d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106b32:	e9 8e f5 ff ff       	jmp    801060c5 <alltraps>
...
80106b39:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106b3e:	e9 82 f5 ff ff       	jmp    801060c5 <alltraps>
...
80106b45:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106b4a:	e9 76 f5 ff ff       	jmp    801060c5 <alltraps>
...
80106b51:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106b56:	e9 6a f5 ff ff       	jmp    801060c5 <alltraps>
...
80106b5d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106b62:	e9 5e f5 ff ff       	jmp    801060c5 <alltraps>
...
80106b69:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106b6e:	e9 52 f5 ff ff       	jmp    801060c5 <alltraps>
...
80106b75:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106b7a:	e9 46 f5 ff ff       	jmp    801060c5 <alltraps>
...
80106b81:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106b86:	e9 3a f5 ff ff       	jmp    801060c5 <alltraps>
...
80106b8d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106b92:	e9 2e f5 ff ff       	jmp    801060c5 <alltraps>
...
80106b99:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106b9e:	e9 22 f5 ff ff       	jmp    801060c5 <alltraps>
...
80106ba5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106baa:	e9 16 f5 ff ff       	jmp    801060c5 <alltraps>
...
80106bb1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106bb6:	e9 0a f5 ff ff       	jmp    801060c5 <alltraps>
...
80106bbd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106bc2:	e9 fe f4 ff ff       	jmp    801060c5 <alltraps>
...
80106bc9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106bce:	e9 f2 f4 ff ff       	jmp    801060c5 <alltraps>
...
80106bd5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106bda:	e9 e6 f4 ff ff       	jmp    801060c5 <alltraps>
...
80106be1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106be6:	e9 da f4 ff ff       	jmp    801060c5 <alltraps>
...
80106bed:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106bf2:	e9 ce f4 ff ff       	jmp    801060c5 <alltraps>
...
80106bf9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106bfe:	e9 c2 f4 ff ff       	jmp    801060c5 <alltraps>
...
80106c05:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106c0a:	e9 b6 f4 ff ff       	jmp    801060c5 <alltraps>
...
80106c11:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106c16:	e9 aa f4 ff ff       	jmp    801060c5 <alltraps>
...
80106c1d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106c22:	e9 9e f4 ff ff       	jmp    801060c5 <alltraps>
...
80106c29:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106c2e:	e9 92 f4 ff ff       	jmp    801060c5 <alltraps>
...
80106c35:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106c3a:	e9 86 f4 ff ff       	jmp    801060c5 <alltraps>
...
80106c41:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106c46:	e9 7a f4 ff ff       	jmp    801060c5 <alltraps>
...
80106c4d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106c52:	e9 6e f4 ff ff       	jmp    801060c5 <alltraps>
...
80106c59:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106c5e:	e9 62 f4 ff ff       	jmp    801060c5 <alltraps>
...
80106c65:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106c6a:	e9 56 f4 ff ff       	jmp    801060c5 <alltraps>
...
80106c71:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106c76:	e9 4a f4 ff ff       	jmp    801060c5 <alltraps>
...
80106c7d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106c82:	e9 3e f4 ff ff       	jmp    801060c5 <alltraps>
...
80106c89:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106c8e:	e9 32 f4 ff ff       	jmp    801060c5 <alltraps>
...
80106c95:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106c9a:	e9 26 f4 ff ff       	jmp    801060c5 <alltraps>
...
80106ca1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106ca6:	e9 1a f4 ff ff       	jmp    801060c5 <alltraps>
...
80106cad:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106cb2:	e9 0e f4 ff ff       	jmp    801060c5 <alltraps>
...
80106cb9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106cbe:	e9 02 f4 ff ff       	jmp    801060c5 <alltraps>
...
80106cc5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106cca:	e9 f6 f3 ff ff       	jmp    801060c5 <alltraps>
...
80106cd1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106cd6:	e9 ea f3 ff ff       	jmp    801060c5 <alltraps>
...
80106cdd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106ce2:	e9 de f3 ff ff       	jmp    801060c5 <alltraps>
...
80106ce9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106cee:	e9 d2 f3 ff ff       	jmp    801060c5 <alltraps>
...
80106cf5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106cfa:	e9 c6 f3 ff ff       	jmp    801060c5 <alltraps>
...
80106d01:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106d06:	e9 ba f3 ff ff       	jmp    801060c5 <alltraps>
...
80106d0d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106d12:	e9 ae f3 ff ff       	jmp    801060c5 <alltraps>
...
80106d19:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106d1e:	e9 a2 f3 ff ff       	jmp    801060c5 <alltraps>
...
80106d25:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106d2a:	e9 96 f3 ff ff       	jmp    801060c5 <alltraps>
...
80106d31:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106d36:	e9 8a f3 ff ff       	jmp    801060c5 <alltraps>
...
80106d3d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106d42:	e9 7e f3 ff ff       	jmp    801060c5 <alltraps>
...
80106d49:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106d4e:	e9 72 f3 ff ff       	jmp    801060c5 <alltraps>
...
80106d55:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106d5a:	e9 66 f3 ff ff       	jmp    801060c5 <alltraps>
...
80106d61:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106d66:	e9 5a f3 ff ff       	jmp    801060c5 <alltraps>
...
80106d6d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106d72:	e9 4e f3 ff ff       	jmp    801060c5 <alltraps>
...
80106d79:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106d7e:	e9 42 f3 ff ff       	jmp    801060c5 <alltraps>
...
80106d85:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106d8a:	e9 36 f3 ff ff       	jmp    801060c5 <alltraps>
...
80106d91:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106d96:	e9 2a f3 ff ff       	jmp    801060c5 <alltraps>
...
80106d9d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106da2:	e9 1e f3 ff ff       	jmp    801060c5 <alltraps>
...
80106da9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106dae:	e9 12 f3 ff ff       	jmp    801060c5 <alltraps>
...
80106db5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106dba:	e9 06 f3 ff ff       	jmp    801060c5 <alltraps>
...
80106dc1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106dc6:	e9 fa f2 ff ff       	jmp    801060c5 <alltraps>
...
80106dcd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106dd2:	e9 ee f2 ff ff       	jmp    801060c5 <alltraps>
...
80106dd9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106dde:	e9 e2 f2 ff ff       	jmp    801060c5 <alltraps>
...
80106de5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106dea:	e9 d6 f2 ff ff       	jmp    801060c5 <alltraps>
...
80106df1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106df6:	e9 ca f2 ff ff       	jmp    801060c5 <alltraps>
...
80106dfd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106e02:	e9 be f2 ff ff       	jmp    801060c5 <alltraps>
...
80106e09:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106e0e:	e9 b2 f2 ff ff       	jmp    801060c5 <alltraps>
...
80106e15:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106e1a:	e9 a6 f2 ff ff       	jmp    801060c5 <alltraps>
...
80106e21:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106e26:	e9 9a f2 ff ff       	jmp    801060c5 <alltraps>
...
80106e2d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106e32:	e9 8e f2 ff ff       	jmp    801060c5 <alltraps>
...
80106e39:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106e3e:	e9 82 f2 ff ff       	jmp    801060c5 <alltraps>
...
80106e45:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106e4a:	e9 76 f2 ff ff       	jmp    801060c5 <alltraps>
...
80106e51:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106e56:	e9 6a f2 ff ff       	jmp    801060c5 <alltraps>
...
80106e5d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106e62:	e9 5e f2 ff ff       	jmp    801060c5 <alltraps>
...
80106e69:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106e6e:	e9 52 f2 ff ff       	jmp    801060c5 <alltraps>
...
80106e75:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106e7a:	e9 46 f2 ff ff       	jmp    801060c5 <alltraps>
...
80106e81:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106e86:	e9 3a f2 ff ff       	jmp    801060c5 <alltraps>
...
80106e8d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106e92:	e9 2e f2 ff ff       	jmp    801060c5 <alltraps>
...
80106e99:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106e9e:	e9 22 f2 ff ff       	jmp    801060c5 <alltraps>
...
80106ea5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106eaa:	e9 16 f2 ff ff       	jmp    801060c5 <alltraps>
...
80106eb1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106eb6:	e9 0a f2 ff ff       	jmp    801060c5 <alltraps>
...
80106ebd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106ec2:	e9 fe f1 ff ff       	jmp    801060c5 <alltraps>
...
80106ec9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106ece:	e9 f2 f1 ff ff       	jmp    801060c5 <alltraps>
...
80106ed5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106eda:	e9 e6 f1 ff ff       	jmp    801060c5 <alltraps>
...
80106ee1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106ee6:	e9 da f1 ff ff       	jmp    801060c5 <alltraps>
...
80106eed:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106ef2:	e9 ce f1 ff ff       	jmp    801060c5 <alltraps>
...
80106ef9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106efe:	e9 c2 f1 ff ff       	jmp    801060c5 <alltraps>
...
80106f05:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106f0a:	e9 b6 f1 ff ff       	jmp    801060c5 <alltraps>
...
80106f11:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106f16:	e9 aa f1 ff ff       	jmp    801060c5 <alltraps>
...
80106f1d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106f22:	e9 9e f1 ff ff       	jmp    801060c5 <alltraps>
...
80106f29:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106f2e:	e9 92 f1 ff ff       	jmp    801060c5 <alltraps>
...
80106f35:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106f3a:	e9 86 f1 ff ff       	jmp    801060c5 <alltraps>
...
80106f41:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106f46:	e9 7a f1 ff ff       	jmp    801060c5 <alltraps>
...
80106f4d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106f52:	e9 6e f1 ff ff       	jmp    801060c5 <alltraps>
...
80106f59:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106f5e:	e9 62 f1 ff ff       	jmp    801060c5 <alltraps>
...
80106f65:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106f6a:	e9 56 f1 ff ff       	jmp    801060c5 <alltraps>
...
80106f71:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106f76:	e9 4a f1 ff ff       	jmp    801060c5 <alltraps>
...
80106f7d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106f82:	e9 3e f1 ff ff       	jmp    801060c5 <alltraps>
...
80106f89:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106f8e:	e9 32 f1 ff ff       	jmp    801060c5 <alltraps>
...
80106f95:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106f9a:	e9 26 f1 ff ff       	jmp    801060c5 <alltraps>
...
80106fa1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106fa6:	e9 1a f1 ff ff       	jmp    801060c5 <alltraps>
...
80106fad:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106fb2:	e9 0e f1 ff ff       	jmp    801060c5 <alltraps>
...
80106fb9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106fbe:	e9 02 f1 ff ff       	jmp    801060c5 <alltraps>
...
80106fc5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106fca:	e9 f6 f0 ff ff       	jmp    801060c5 <alltraps>
...
80106fd1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106fd6:	e9 ea f0 ff ff       	jmp    801060c5 <alltraps>
...
80106fdd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106fe2:	e9 de f0 ff ff       	jmp    801060c5 <alltraps>
...
80106fe9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106fee:	e9 d2 f0 ff ff       	jmp    801060c5 <alltraps>
...
80106ff5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106ffa:	e9 c6 f0 ff ff       	jmp    801060c5 <alltraps>
...
80107001:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107006:	e9 ba f0 ff ff       	jmp    801060c5 <alltraps>
...
8010700d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107012:	e9 ae f0 ff ff       	jmp    801060c5 <alltraps>
...
80107019:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010701e:	e9 a2 f0 ff ff       	jmp    801060c5 <alltraps>
...
80107025:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010702a:	e9 96 f0 ff ff       	jmp    801060c5 <alltraps>
...
80107031:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107036:	e9 8a f0 ff ff       	jmp    801060c5 <alltraps>
...
8010703d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107042:	e9 7e f0 ff ff       	jmp    801060c5 <alltraps>
...
80107049:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010704e:	e9 72 f0 ff ff       	jmp    801060c5 <alltraps>
...
80107055:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010705a:	e9 66 f0 ff ff       	jmp    801060c5 <alltraps>
...
80107061:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107066:	e9 5a f0 ff ff       	jmp    801060c5 <alltraps>
...
8010706d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107072:	e9 4e f0 ff ff       	jmp    801060c5 <alltraps>
...
80107095:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80107098:	39 d3                	cmp    %edx,%ebx
8010709a:	73 49                	jae    801070e5 <deallocuvm.part.0+0x65>
8010709c:	89 c7                	mov    %eax,%edi
8010709e:	eb 0c                	jmp    801070ac <deallocuvm.part.0+0x2c>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801070a0:	83 c0 01             	add    $0x1,%eax
801070a3:	c1 e0 16             	shl    $0x16,%eax
801070a6:	89 c3                	mov    %eax,%ebx
  for(; a  < oldsz; a += PGSIZE){
801070a8:	39 da                	cmp    %ebx,%edx
801070aa:	76 39                	jbe    801070e5 <deallocuvm.part.0+0x65>
  pde = &pgdir[PDX(va)];
801070ac:	89 d8                	mov    %ebx,%eax
801070ae:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
801070b1:	8b 0c 87             	mov    (%edi,%eax,4),%ecx
801070b4:	f6 c1 01             	test   $0x1,%cl
801070b7:	74 e7                	je     801070a0 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
801070b9:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801070bb:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
801070c1:	c1 ee 0a             	shr    $0xa,%esi
801070c4:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
801070ca:	8d b4 31 00 00 00 80 	lea    -0x80000000(%ecx,%esi,1),%esi
    if(!pte)
801070d1:	85 f6                	test   %esi,%esi
801070d3:	74 cb                	je     801070a0 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
801070d5:	8b 06                	mov    (%esi),%eax
801070d7:	a8 01                	test   $0x1,%al
801070d9:	75 15                	jne    801070f0 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
801070db:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801070e1:	39 da                	cmp    %ebx,%edx
801070e3:	77 c7                	ja     801070ac <deallocuvm.part.0+0x2c>
      kfree(v);
      *pte = 0;
    }
  }
...
801070e5:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
801070f5:	74 25                	je     8010711c <deallocuvm.part.0+0x9c>
      kfree(v);
801070f7:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
801070fa:	05 00 00 00 80       	add    $0x80000000,%eax
801070ff:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80107102:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80107108:	50                   	push   %eax
80107109:	e8 b2 b3 ff ff       	call   801024c0 <kfree>
      *pte = 0;
8010710e:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  for(; a  < oldsz; a += PGSIZE){
80107114:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107117:	83 c4 10             	add    $0x10,%esp
8010711a:	eb 8c                	jmp    801070a8 <deallocuvm.part.0+0x28>
        panic("kfree");
8010711c:	83 ec 0c             	sub    $0xc,%esp
8010711f:	68 e6 7c 10 80       	push   $0x80107ce6
...
8010714d:	89 45 dc             	mov    %eax,-0x24(%ebp)
80107150:	8b 45 08             	mov    0x8(%ebp),%eax
80107153:	29 d8                	sub    %ebx,%eax
80107155:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107158:	eb 3d                	jmp    80107197 <mappages+0x67>
...
80107179:	74 75                	je     801071f0 <mappages+0xc0>
    if(*pte & PTE_P)
8010717b:	f6 00 01             	testb  $0x1,(%eax)
8010717e:	0f 85 86 00 00 00    	jne    8010720a <mappages+0xda>
    *pte = pa | perm | PTE_P;
80107184:	0b 75 0c             	or     0xc(%ebp),%esi
80107187:	83 ce 01             	or     $0x1,%esi
8010718a:	89 30                	mov    %esi,(%eax)
    if(a == last)
8010718c:	3b 5d dc             	cmp    -0x24(%ebp),%ebx
8010718f:	74 6f                	je     80107200 <mappages+0xd0>
    a += PGSIZE;
80107191:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80107197:	8b 45 e0             	mov    -0x20(%ebp),%eax
  pde = &pgdir[PDX(va)];
8010719a:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010719d:	8d 34 18             	lea    (%eax,%ebx,1),%esi
801071a0:	89 d8                	mov    %ebx,%eax
801071a2:	c1 e8 16             	shr    $0x16,%eax
801071a5:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
801071a8:	8b 07                	mov    (%edi),%eax
801071aa:	a8 01                	test   $0x1,%al
801071ac:	75 b2                	jne    80107160 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
801071ae:	e8 cd b4 ff ff       	call   80102680 <kalloc>
801071b3:	85 c0                	test   %eax,%eax
801071b5:	74 39                	je     801071f0 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
801071b7:	83 ec 04             	sub    $0x4,%esp
801071ba:	89 45 d8             	mov    %eax,-0x28(%ebp)
801071bd:	68 00 10 00 00       	push   $0x1000
801071c2:	6a 00                	push   $0x0
801071c4:	50                   	push   %eax
801071c5:	e8 e6 dc ff ff       	call   80104eb0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
801071ca:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
801071cd:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
801071d0:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
801071d6:	83 c8 07             	or     $0x7,%eax
801071d9:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
801071db:	89 d8                	mov    %ebx,%eax
801071dd:	c1 e8 0a             	shr    $0xa,%eax
801071e0:	25 fc 0f 00 00       	and    $0xffc,%eax
801071e5:	01 d0                	add    %edx,%eax
801071e7:	eb 92                	jmp    8010717b <mappages+0x4b>
...
8010720d:	68 5c 83 10 80       	push   $0x8010835c
...
80107223:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80107226:	e8 05 c8 ff ff       	call   80103a30 <cpuid>
  pd[0] = size-1;
8010722b:	ba 2f 00 00 00       	mov    $0x2f,%edx
80107230:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80107236:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010723a:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
80107241:	ff 00 00 
80107244:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
8010724b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010724e:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
80107255:	ff 00 00 
80107258:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
8010725f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107262:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
80107269:	ff 00 00 
8010726c:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
80107273:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107276:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
8010727d:	ff 00 00 
80107280:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
80107287:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
8010728a:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
8010728f:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80107293:	c1 e8 10             	shr    $0x10,%eax
80107296:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
8010729a:	8d 45 f2             	lea    -0xe(%ebp),%eax
8010729d:	0f 01 10             	lgdtl  (%eax)
}
801072a0:	c9                   	leave  
801072a1:	c3                   	ret    
...
801072b0:	a1 c4 5b 11 80       	mov    0x80115bc4,%eax
...
801072ce:	0f 84 cb 00 00 00    	je     8010739f <switchuvm+0xdf>
  if(p->kstack == 0)
801072d4:	8b 46 08             	mov    0x8(%esi),%eax
801072d7:	85 c0                	test   %eax,%eax
801072d9:	0f 84 da 00 00 00    	je     801073b9 <switchuvm+0xf9>
  if(p->pgdir == 0)
801072df:	8b 46 04             	mov    0x4(%esi),%eax
801072e2:	85 c0                	test   %eax,%eax
801072e4:	0f 84 c2 00 00 00    	je     801073ac <switchuvm+0xec>
  pushcli();
801072ea:	e8 b1 d9 ff ff       	call   80104ca0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801072ef:	e8 dc c6 ff ff       	call   801039d0 <mycpu>
801072f4:	89 c3                	mov    %eax,%ebx
801072f6:	e8 d5 c6 ff ff       	call   801039d0 <mycpu>
801072fb:	89 c7                	mov    %eax,%edi
801072fd:	e8 ce c6 ff ff       	call   801039d0 <mycpu>
80107302:	83 c7 08             	add    $0x8,%edi
80107305:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107308:	e8 c3 c6 ff ff       	call   801039d0 <mycpu>
8010730d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80107310:	ba 67 00 00 00       	mov    $0x67,%edx
80107315:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
8010731c:	83 c0 08             	add    $0x8,%eax
8010731f:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107326:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010732b:	83 c1 08             	add    $0x8,%ecx
8010732e:	c1 e8 18             	shr    $0x18,%eax
80107331:	c1 e9 10             	shr    $0x10,%ecx
80107334:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
8010733a:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80107340:	b9 99 40 00 00       	mov    $0x4099,%ecx
80107345:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010734c:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80107351:	e8 7a c6 ff ff       	call   801039d0 <mycpu>
80107356:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010735d:	e8 6e c6 ff ff       	call   801039d0 <mycpu>
80107362:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80107366:	8b 5e 08             	mov    0x8(%esi),%ebx
80107369:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010736f:	e8 5c c6 ff ff       	call   801039d0 <mycpu>
80107374:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107377:	e8 54 c6 ff ff       	call   801039d0 <mycpu>
...
801073dc:	8b 75 10             	mov    0x10(%ebp),%esi
801073df:	8b 7d 08             	mov    0x8(%ebp),%edi
801073e2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
801073e5:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
801073eb:	77 4b                	ja     80107438 <inituvm+0x68>
  mem = kalloc();
801073ed:	e8 8e b2 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
801073f2:	83 ec 04             	sub    $0x4,%esp
801073f5:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
801073fa:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801073fc:	6a 00                	push   $0x0
801073fe:	50                   	push   %eax
801073ff:	e8 ac da ff ff       	call   80104eb0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80107404:	58                   	pop    %eax
80107405:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010740b:	5a                   	pop    %edx
8010740c:	6a 06                	push   $0x6
8010740e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107413:	31 d2                	xor    %edx,%edx
80107415:	50                   	push   %eax
80107416:	89 f8                	mov    %edi,%eax
80107418:	e8 13 fd ff ff       	call   80107130 <mappages>
  memmove(mem, init, sz);
8010741d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107420:	89 75 10             	mov    %esi,0x10(%ebp)
80107423:	83 c4 10             	add    $0x10,%esp
80107426:	89 5d 08             	mov    %ebx,0x8(%ebp)
80107429:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80107432:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107433:	e9 18 db ff ff       	jmp    80104f50 <memmove>
    panic("inituvm: more than a page");
80107438:	83 ec 0c             	sub    $0xc,%esp
8010743b:	68 a1 83 10 80       	push   $0x801083a1
80107440:	e8 3b 8f ff ff       	call   80100380 <panic>
...
8010745c:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
8010745f:	a9 ff 0f 00 00       	test   $0xfff,%eax
80107464:	0f 85 bb 00 00 00    	jne    80107525 <loaduvm+0xd5>
  for(i = 0; i < sz; i += PGSIZE){
8010746a:	01 f0                	add    %esi,%eax
8010746c:	89 f3                	mov    %esi,%ebx
8010746e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107471:	8b 45 14             	mov    0x14(%ebp),%eax
80107474:	01 f0                	add    %esi,%eax
80107476:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80107479:	85 f6                	test   %esi,%esi
8010747b:	0f 84 87 00 00 00    	je     80107508 <loaduvm+0xb8>
80107481:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
80107488:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  if(*pde & PTE_P){
8010748b:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010748e:	29 d8                	sub    %ebx,%eax
  pde = &pgdir[PDX(va)];
80107490:	89 c2                	mov    %eax,%edx
80107492:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80107495:	8b 14 91             	mov    (%ecx,%edx,4),%edx
80107498:	f6 c2 01             	test   $0x1,%dl
8010749b:	75 13                	jne    801074b0 <loaduvm+0x60>
      panic("loaduvm: address should exist");
8010749d:	83 ec 0c             	sub    $0xc,%esp
801074a0:	68 bb 83 10 80       	push   $0x801083bb
801074a5:	e8 d6 8e ff ff       	call   80100380 <panic>
...
801074c7:	74 d4                	je     8010749d <loaduvm+0x4d>
    pa = PTE_ADDR(*pte);
...
801074eb:	ff 75 10             	push   0x10(%ebp)
801074ee:	e8 9d a5 ff ff       	call   80101a90 <readi>
801074f3:	83 c4 10             	add    $0x10,%esp
801074f6:	39 f8                	cmp    %edi,%eax
801074f8:	75 1e                	jne    80107518 <loaduvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
801074fa:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80107500:	89 f0                	mov    %esi,%eax
80107502:	29 d8                	sub    %ebx,%eax
80107504:	39 c6                	cmp    %eax,%esi
80107506:	77 80                	ja     80107488 <loaduvm+0x38>
}
...
80107528:	68 5c 84 10 80       	push   $0x8010845c
8010752d:	e8 4e 8e ff ff       	call   80100380 <panic>
...
80107546:	83 ec 1c             	sub    $0x1c,%esp
  if(newsz >= KERNBASE)
80107549:	8b 45 10             	mov    0x10(%ebp),%eax
{
8010754c:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
8010754f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107552:	85 c0                	test   %eax,%eax
80107554:	0f 88 b6 00 00 00    	js     80107610 <allocuvm+0xd0>
  if(newsz < oldsz)
8010755a:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
8010755d:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80107560:	0f 82 9a 00 00 00    	jb     80107600 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80107566:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
8010756c:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80107572:	39 75 10             	cmp    %esi,0x10(%ebp)
80107575:	77 44                	ja     801075bb <allocuvm+0x7b>
80107577:	e9 87 00 00 00       	jmp    80107603 <allocuvm+0xc3>
...
8010758b:	e8 20 d9 ff ff       	call   80104eb0 <memset>
...
801075a4:	e8 87 fb ff ff       	call   80107130 <mappages>
...
801075b9:	76 48                	jbe    80107603 <allocuvm+0xc3>
    mem = kalloc();
801075bb:	e8 c0 b0 ff ff       	call   80102680 <kalloc>
...
801075c9:	68 d9 83 10 80       	push   $0x801083d9
801075ce:	e8 cd 90 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
...
801075e5:	e8 96 fa ff ff       	call   80107080 <deallocuvm.part.0>
      return 0;
...
8010762b:	68 f1 83 10 80       	push   $0x801083f1
...
80107647:	e8 34 fa ff ff       	call   80107080 <deallocuvm.part.0>
      kfree(mem);
8010764c:	83 ec 0c             	sub    $0xc,%esp
8010764f:	53                   	push   %ebx
80107650:	e8 6b ae ff ff       	call   801024c0 <kfree>
      return 0;
...
801076c8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801076cf:	90                   	nop
...
801076ee:	e8 cd ad ff ff       	call   801024c0 <kfree>
...
80107703:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107704:	e9 b7 ad ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80107709:	83 ec 0c             	sub    $0xc,%esp
8010770c:	68 0d 84 10 80       	push   $0x8010840d
...
8010772a:	89 c6                	mov    %eax,%esi
8010772c:	85 c0                	test   %eax,%eax
8010772e:	74 42                	je     80107772 <setupkvm+0x52>
...
80107740:	e8 6b d7 ff ff       	call   80104eb0 <memset>
...
80107751:	ff 73 0c             	push   0xc(%ebx)
80107754:	8b 13                	mov    (%ebx),%edx
80107756:	50                   	push   %eax
80107757:	29 c1                	sub    %eax,%ecx
80107759:	89 f0                	mov    %esi,%eax
8010775b:	e8 d0 f9 ff ff       	call   80107130 <mappages>
...
801077ab:	a3 c4 5b 11 80       	mov    %eax,0x80115bc4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801077dc:	68 1e 84 10 80       	push   $0x8010841e
...
80107823:	0f 84 bd 00 00 00    	je     801078e6 <copyuvm+0xd6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80107852:	68 28 84 10 80       	push   $0x80108428
80107857:	e8 24 8b ff ff       	call   80100380 <panic>
...
8010788f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107895:	e8 e6 ad ff ff       	call   80102680 <kalloc>
...
801078b0:	e8 9b d6 ff ff       	call   80104f50 <memmove>
...
801078cb:	e8 60 f8 ff ff       	call   80107130 <mappages>
...
801078dd:	39 75 0c             	cmp    %esi,0xc(%ebp)
801078e0:	0f 87 5a ff ff ff    	ja     80107840 <copyuvm+0x30>
  return d;
...
801078fc:	e8 bf ab ff ff       	call   801024c0 <kfree>
      goto bad;
...
8010790a:	e8 91 fd ff ff       	call   801076a0 <freevm>
  return 0;
8010790f:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
80107927:	68 42 84 10 80       	push   $0x80108442
8010792c:	e8 4f 8a ff ff       	call   80100380 <panic>
...
80107954:	0f 84 00 01 00 00    	je     80107a5a <uva2ka.cold>
  return &pgtab[PTX(va)];
...
80107964:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
80107969:	8b 84 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%eax
  if((*pte & PTE_U) == 0)
80107970:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107972:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
80107977:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
8010797a:	05 00 00 00 80       	add    $0x80000000,%eax
8010797f:	83 fa 05             	cmp    $0x5,%edx
80107982:	ba 00 00 00 00       	mov    $0x0,%edx
80107987:	0f 45 c2             	cmovne %edx,%eax
}
8010798a:	c3                   	ret    
...
801079a6:	e9 a5 00 00 00       	jmp    80107a50 <copyout+0xc0>
...
801079c2:	74 75                	je     80107a39 <copyout+0xa9>
      return -1;
    n = PGSIZE - (va - va0);
...
801079c6:	89 55 10             	mov    %edx,0x10(%ebp)
    n = PGSIZE - (va - va0);
801079c9:	29 c3                	sub    %eax,%ebx
801079cb:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801079d1:	39 f3                	cmp    %esi,%ebx
801079d3:	0f 47 de             	cmova  %esi,%ebx
    memmove(pa0 + (va - va0), buf, n);
801079d6:	29 f8                	sub    %edi,%eax
801079d8:	83 ec 04             	sub    $0x4,%esp
801079db:	01 c1                	add    %eax,%ecx
801079dd:	53                   	push   %ebx
801079de:	52                   	push   %edx
...
801079f5:	74 59                	je     80107a50 <copyout+0xc0>
  if(*pde & PTE_P){
...
80107a0d:	0f 84 4e 00 00 00    	je     80107a61 <copyout.cold>
  return &pgtab[PTX(va)];
...
80107a2d:	83 e1 05             	and    $0x5,%ecx
80107a30:	83 f9 05             	cmp    $0x5,%ecx
80107a33:	0f 84 77 ff ff ff    	je     801079b0 <copyout+0x20>
  }
  return 0;
}
...
80107a5a <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
80107a5a:	a1 00 00 00 00       	mov    0x0,%eax
80107a5f:	0f 0b                	ud2    

80107a61 <copyout.cold>:
