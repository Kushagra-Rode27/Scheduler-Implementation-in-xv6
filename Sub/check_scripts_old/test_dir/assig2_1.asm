...
_assig2_1:     file format elf32-i386
...
{   
  ...
  13:	c7 45 d0 12 00 00 00 	movl   $0x12,-0x30(%ebp)
  1a:	c7 45 d4 18 00 00 00 	movl   $0x18,-0x2c(%ebp)
  21:	c7 45 d8 15 00 00 00 	movl   $0x15,-0x28(%ebp)
  ...
  47:	89 c3                	mov    %eax,%ebx
    deadline(parent_pid, 19);
  49:	50                   	push   %eax
  4a:	e8 64 03 00 00       	call   3b3 <deadline>
    exec_time(parent_pid, 4);
  4f:	58                   	pop    %eax
  50:	5a                   	pop    %edx
  51:	6a 04                	push   $0x4
  53:	53                   	push   %ebx
  54:	e8 52 03 00 00       	call   3ab <exec_time>
  ...
  5e:	31 f6                	xor    %esi,%esi
    sched_policy(parent_pid, 0);
  60:	e8 3e 03 00 00       	call   3a3 <sched_policy>
  ...
  7a:	50                   	push   %eax
  7b:	e8 33 03 00 00       	call   3b3 <deadline>
  ...
  87:	83 c6 01             	add    $0x1,%esi
            exec_time(cid, exectime[i]);
  8a:	e8 1c 03 00 00       	call   3ab <exec_time>
            sched_policy(cid, 0);
  8f:	59                   	pop    %ecx
  90:	58                   	pop    %eax
  91:	6a 00                	push   $0x0
  93:	53                   	push   %ebx
  94:	e8 0a 03 00 00       	call   3a3 <sched_policy>
    for(int i = 0; i < num_procs; i++)
 ...
 621:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 b8 0a 00 00    	mov    %edx,0xab8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf bc 0a 00 00       	mov    $0xabc,%edi
    base.s.ptr = freep = prevp = &base;
